// ============================================================================
// GETKINETIK Bureau — Independent Sybil Risk Scan
//
...
//
// Example:
//   node scripts/sybil-report.mjs scripts/sample-nodes.json \
//     --network=ExampleDePIN --out=docs/reports/example-sybil-report.md
//
// Input schema (see scripts/sample-nodes.json for a full example):
//   [
//     {
...
//   ]
//
// The script never phones home and never touches the live bureau. It runs the
// same heuristic *shape* the bureau uses internally (co-location, birth burst,
// beat-rate impossibility, metadata twins) and writes a markdown file. Use it
// to seed conversations; partners should still call /api/verify-device for
// authoritative GETKINETIK grades on any node they want a second opinion on.
// ============================================================================
...
lines.push("");
lines.push(
  `> Independent scan generated by the GETKINETIK Bureau using a subset of the` +
