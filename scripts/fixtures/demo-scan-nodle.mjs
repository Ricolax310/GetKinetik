// ⚠️ SYNTHETIC DEMO FIXTURE — NOT REAL NODLE DATA. ⚠️
// Every node in this file is generated by Math.random(); it exists only to
// illustrate the heuristics pipeline shape. Its output MUST NEVER be wired
// into the bureau registry, audit index, signal pipeline, or any published
// surface. See NEUTRALITY.md.
