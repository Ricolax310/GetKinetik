...
**Generated:** 2026-05-23T22:13:51.376Z  
...
2. 68 devices in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. 93 drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,490 | +2 (+0.0%) ↓ |
| Cells ≥1.5× capacity | 288 | unchanged vs last run |
| Share of map over capacity | 3.39% | -0.00 pp (-0.0%) ↓ |
| `NO_LOCATION_DATA` in drilled set | 68 | +13 (+23.6%) ↑ |
| Devices with qod < 30 (drilled) | 93 | +25 (+36.8%) ↑ |
