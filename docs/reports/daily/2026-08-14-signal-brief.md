...
- **Geodnet** — entities on public map: 19,529 (-14 (-0.1%))
- **WeatherXM** — cells over designed capacity: 291 (+2 (+0.7%))
- **DIMO** — entities on public map: 158,502 (+12 (+0.0%))
...
Public read on Geodnet: 5 exact (lat,lng) duplicate groups on 19,543 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
