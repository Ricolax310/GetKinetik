...
> 2026-07-07 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **Geodnet** — entities on public map: 19,563 (-7 (-0.0%))
- **WeatherXM** — cells over designed capacity: 288 (-1 (-0.3%))
- **DIMO** — entities on public map: 158,222 (+11 (+0.0%))
...
Public read on Geodnet: 10 exact (lat,lng) duplicate groups on 19,570 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
