...
> 2026-06-12 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• Geodnet duplicate-coordinate groups rose from 8 to 10.
• WeatherXM over-capacity cells declined from 290 to 287.
• Geodnet entities on public map rose from 19,595 to 19,597.
...
Public read on Geodnet: 10 exact (lat,lng) duplicate groups on 19,597 public stations — each row in §1 is one coordinate pai — does that match your internal view, or is the public feed expected to behave this way?
