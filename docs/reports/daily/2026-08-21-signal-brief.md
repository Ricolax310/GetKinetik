...
> 2026-08-21 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• Helium Mobile entities on public map rose from 54,965 to 54,982.
• Helium Mobile single-coordinate hotspot stacks rose from 526 to 527.
