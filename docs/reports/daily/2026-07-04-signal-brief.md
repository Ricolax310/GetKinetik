...
> 2026-07-04 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **DIMO** — entities on public map: 158,192 (+12 (+0.0%))
- **WeatherXM** — 290 cells exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
...
Public read on Geodnet: 8 exact (lat,lng) duplicate groups on 19,572 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
