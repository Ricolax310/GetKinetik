...
- **Geodnet** — entities on public map: 19,511 (-10 (-0.1%))
- **WeatherXM** — cells over designed capacity: 293 (+3 (+1.0%))
...
Public read on Geodnet: 5 exact (lat,lng) duplicate groups on 19,521 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
