...
> 2026-09-19 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **Geodnet** — exact (lat,lng) duplicate groups: 1,008 (-22 (-2.1%))
- **Geodnet** — entities on public map: 19,496 (-15 (-0.1%))
- **DIMO** — entities on public map: 158,653 (+6 (+0.0%))
- **WeatherXM** — 300 cells exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
- **Hivemapper** — 52.34% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read.
