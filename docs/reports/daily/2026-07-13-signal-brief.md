...
> 2026-07-13 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
Public read on Geodnet: 10 exact (lat,lng) duplicate groups on 19,560 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
