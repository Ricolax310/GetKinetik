...
> 2026-08-25 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
• Helium Mobile flagged fleet share declined from 21% to 20%.
...
- **DIMO** — entities on public map: 158,584 (+10 (+0.0%))
- **Helium Mobile** — entities on public map: 55,541 (+559 (+1.0%))
- **Helium Mobile** — single-coordinate stacks (≥10 hotspots): 529 (+2 (+0.4%))
- **Helium Mobile** — fleet share flagged (any heuristic): 20.38% (-0.16 pp (-0.8%))
- **Geodnet** — 8 exact (lat,lng) duplicate groups on 19,505 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
Public read on Geodnet: 8 exact (lat,lng) duplicate groups on 19,510 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
