...
> 2026-06-26 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• Geodnet duplicate-coordinate groups declined from 8 to 7.
• WeatherXM over-capacity cells declined from 289 to 287.
• DIMO entities on public map rose from 158,097 to 158,119.
• Geodnet entities on public map declined from 19,585 to 19,576.
