...
> 2026-08-06 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **Geodnet** — entities on public map: 19,562 (-23 (-0.1%))
- **DIMO** — entities on public map: 158,434 (+14 (+0.0%))
