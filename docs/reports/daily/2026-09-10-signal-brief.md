...
> 2026-09-10 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **Geodnet** — exact (lat,lng) duplicate groups: 1,011 (+2 (+0.2%))
- **WeatherXM** — cells over designed capacity: 298 (-1 (-0.3%))
- **DIMO** — entities on public map: 158,651 (+8 (+0.0%))
- **Helium IoT** — entities on public map: 1,008,240 (+9 (+0.0%))
- **Helium Mobile** — entities on public map: 55,633 (+38 (+0.1%))
...
Public read on Geodnet: 1009 exact (lat,lng) duplicate groups on 19,482 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
