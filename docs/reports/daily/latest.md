...
> 2026-07-17 · automated cross-network pipeline · evidence not verdicts
...
• DIMO entities on public map rose from 158,283 to 158,289.
...
- **Geodnet** — 7 exact (lat,lng) duplicate groups on 19,579 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,289 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,416 (19.8%) connect via software/synthetic devices, and 86,251 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **DIMO** — entities on public map: 158,289 (+6 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 50.81% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 7 exact (lat,lng) duplicate groups on 19,579 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Hivemapper
- [economics] 50.81% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,289 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,416 (19.8%) connect via software/synthetic devices, and 86,251 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
- [growth] entities on public map: 158,289 (+6 (+0.0%)) _(low · conf 0.85)_
