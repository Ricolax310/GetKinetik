...
• Helium Mobile largest hotspot stack rose from 540 to 565.
...
- **Geodnet** — 1001 exact (lat,lng) duplicate groups on 19,511 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **Helium Mobile** — largest single-coordinate stack: 565 (+25 (+4.6%)) _(medium · conf 0.85)_
...
- **DIMO** — Of 158,679 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,413 (19.8%) connect via software/synthetic devices, and 86,644 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_

**Token economics**
- **Hivemapper** — 52.14% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 1001 exact (lat,lng) duplicate groups on 19,511 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Hivemapper
- [economics] 52.14% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
- [integrity] largest single-coordinate stack: 565 (+25 (+4.6%)) _(medium · conf 0.85)_

### DIMO
- [health] Of 158,679 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,413 (19.8%) connect via software/synthetic devices, and 86,644 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
