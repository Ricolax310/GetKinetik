...
| Coverage growth | 2 | Helium IoT, WeatherXM | low |
| Token economics | 1 | Hivemapper | medium |

_Totals: 10 signal(s) across 5/7 networks._

### What Changed Today

**Registry & identity integrity**
- **Geodnet** — 10 exact (lat,lng) duplicate groups on 19,618 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 10 (-1 (-9.1%)) _(high · conf 0.85)_
- **Helium IoT** — 4,858 single-coordinate stacks of ≥10 hotspots on 1,008,046 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
- **Helium IoT** — largest single-coordinate stack: 502 (+1 (+0.2%)) _(low · conf 0.85)_
- **Helium Mobile** — 529 single-coordinate stacks of ≥10 hotspots on 54,703 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_

**Network health & capacity**
- **WeatherXM** — 284 cells exceed designed capacity — §1 lists H3 indices + map centers for your ops queue. _(medium · conf 0.70)_
- **WeatherXM** — cells over designed capacity: 284 (-1 (-0.4%)) _(low · conf 0.85)_

**Coverage growth**
- **WeatherXM** — entities on public map: 8,502 (+6 (+0.1%)) _(low · conf 0.85)_
- **Helium IoT** — entities on public map: 1,008,046 (+6 (+0.0%)) _(low · conf 0.85)_
...
- **Coverage growth** (`growth`) — 2 signal(s) across 2 network(s): Helium IoT, WeatherXM
...
- **Coverage growth** — public growth signals across Helium IoT, WeatherXM.
...
### Geodnet
- [integrity] 10 exact (lat,lng) duplicate groups on 19,618 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] exact (lat,lng) duplicate groups: 10 (-1 (-9.1%)) _(high · conf 0.85)_

### WeatherXM
- [health] 284 cells exceed designed capacity — §1 lists H3 indices + map centers for your ops queue. _(medium · conf 0.70)_
- [growth] entities on public map: 8,502 (+6 (+0.1%)) _(low · conf 0.85)_
- [health] cells over designed capacity: 284 (-1 (-0.4%)) _(low · conf 0.85)_
...
### Helium IoT
- [integrity] 4,858 single-coordinate stacks of ≥10 hotspots on 1,008,046 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
- [growth] entities on public map: 1,008,046 (+6 (+0.0%)) _(low · conf 0.85)_
- [integrity] largest single-coordinate stack: 502 (+1 (+0.2%)) _(low · conf 0.85)_

### Helium Mobile
- [integrity] 529 single-coordinate stacks of ≥10 hotspots on 54,703 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
