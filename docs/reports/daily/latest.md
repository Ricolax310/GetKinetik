...
• WeatherXM over-capacity cells rose from 288 to 290.
...
- **Geodnet** — 8 exact (lat,lng) duplicate groups on 19,572 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 8 (-1 (-11.1%)) _(high · conf 0.85)_
- **Helium IoT** — 4,861 single-coordinate stacks of ≥10 hotspots on 1,008,090 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
- **WeatherXM** — cells over designed capacity: 290 (+2 (+0.7%)) _(low · conf 0.85)_
- **DIMO** — Of 158,180 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,413 (19.9%) connect via software/synthetic devices, and 86,145 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 8 exact (lat,lng) duplicate groups on 19,572 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- [health] cells over designed capacity: 290 (+2 (+0.7%)) _(low · conf 0.85)_
...
### Helium IoT
- [integrity] 4,861 single-coordinate stacks of ≥10 hotspots on 1,008,090 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,180 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,413 (19.9%) connect via software/synthetic devices, and 86,145 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
