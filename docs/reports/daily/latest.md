...
- **Geodnet** — 1019 exact (lat,lng) duplicate groups on 19,502 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,641 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,429 (19.8%) connect via software/synthetic devices, and 86,590 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Geodnet** — entities on public map: 19,502 (+6 (+0.0%)) _(low · conf 0.85)_
- **DIMO** — entities on public map: 158,641 (+10 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 52.19% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 1019 exact (lat,lng) duplicate groups on 19,502 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Hivemapper
- [economics] 52.19% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,641 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,429 (19.8%) connect via software/synthetic devices, and 86,590 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
- [growth] entities on public map: 158,641 (+10 (+0.0%)) _(low · conf 0.85)_
