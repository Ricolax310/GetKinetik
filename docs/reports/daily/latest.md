...
• Geodnet duplicate-coordinate groups declined from 1,014 to 1,012.
• WeatherXM over-capacity cells rose from 297 to 298.
...
- **Geodnet** — 1012 exact (lat,lng) duplicate groups on 19,481 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,656 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,437 (19.8%) connect via software/synthetic devices, and 86,597 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 1012 exact (lat,lng) duplicate groups on 19,481 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,656 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,437 (19.8%) connect via software/synthetic devices, and 86,597 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
