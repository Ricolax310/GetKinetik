...
> 2026-07-26 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups rose from 7 to 9.
• WeatherXM over-capacity cells unchanged at 288.
• DIMO entities on public map rose from 158,375 to 158,387.
...
- **Geodnet** — 9 exact (lat,lng) duplicate groups on 19,602 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,387 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,424 (19.8%) connect via software/synthetic devices, and 86,341 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **DIMO** — entities on public map: 158,387 (+12 (+0.0%)) _(low · conf 0.85)_
...
### Geodnet
- [integrity] 9 exact (lat,lng) duplicate groups on 19,602 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,387 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,424 (19.8%) connect via software/synthetic devices, and 86,341 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
- [growth] entities on public map: 158,387 (+12 (+0.0%)) _(low · conf 0.85)_
