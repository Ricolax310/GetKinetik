...
- **Geodnet** — 10 exact (lat,lng) duplicate groups on 19,599 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **Helium Mobile** — 530 single-coordinate stacks of ≥10 hotspots on 54,708 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 10 exact (lat,lng) duplicate groups on 19,599 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Helium Mobile
- [integrity] 530 single-coordinate stacks of ≥10 hotspots on 54,708 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
