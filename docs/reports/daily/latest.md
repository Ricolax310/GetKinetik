...
> 2026-07-22 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups declined from 10 to 9.
• WeatherXM over-capacity cells declined from 290 to 289.
• Helium Mobile entities on public map rose from 54,842 to 54,853.
• DIMO entities on public map rose from 158,315 to 158,322.
...
- **Helium Mobile** — 528 single-coordinate stacks of ≥10 hotspots on 54,853 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
- **DIMO** — Of 158,322 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,419 (19.8%) connect via software/synthetic devices, and 86,281 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Helium Mobile** — entities on public map: 54,853 (+11 (+0.0%)) _(low · conf 0.85)_
- **DIMO** — entities on public map: 158,322 (+7 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 50.70% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Hivemapper
- [economics] 50.70% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Helium Mobile
- [integrity] 528 single-coordinate stacks of ≥10 hotspots on 54,853 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
- [growth] entities on public map: 54,853 (+11 (+0.0%)) _(low · conf 0.85)_

### DIMO
- [health] Of 158,322 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,419 (19.8%) connect via software/synthetic devices, and 86,281 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
- [growth] entities on public map: 158,322 (+7 (+0.0%)) _(low · conf 0.85)_
