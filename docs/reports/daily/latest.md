...
• Geodnet entities on public map rose from 19,594 to 19,600.
...
- **Geodnet** — 7 exact (lat,lng) duplicate groups on 19,600 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 7 (-1 (-12.5%)) _(high · conf 0.85)_
...
- **DIMO** — Of 158,301 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,417 (19.8%) connect via software/synthetic devices, and 86,262 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Geodnet** — entities on public map: 19,600 (+6 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 50.96% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 7 exact (lat,lng) duplicate groups on 19,600 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] exact (lat,lng) duplicate groups: 7 (-1 (-12.5%)) _(high · conf 0.85)_
- [growth] entities on public map: 19,600 (+6 (+0.0%)) _(low · conf 0.85)_
...
### Hivemapper
- [economics] 50.96% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,301 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,417 (19.8%) connect via software/synthetic devices, and 86,262 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
