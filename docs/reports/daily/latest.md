...
> 2026-08-21 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups unchanged at 6.
• WeatherXM over-capacity cells unchanged at 289.
• Helium Mobile entities on public map rose from 54,965 to 54,982.
...
- **Geodnet** — 6 exact (lat,lng) duplicate groups on 19,494 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,554 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,450 (19.8%) connect via software/synthetic devices, and 86,482 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Helium Mobile** — entities on public map: 54,982 (+17 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 47.87% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 6 exact (lat,lng) duplicate groups on 19,494 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_

### WeatherXM
- [health] 289 cells exceed designed capacity — §1 lists H3 indices + map centers for your ops queue. _(medium · conf 0.70)_

### Hivemapper
- [economics] 47.87% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
- [growth] entities on public map: 54,982 (+17 (+0.0%)) _(low · conf 0.85)_
- [integrity] single-coordinate stacks (≥10 hotspots): 527 (+1 (+0.2%)) _(low · conf 0.85)_

### DIMO
- [health] Of 158,554 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,450 (19.8%) connect via software/synthetic devices, and 86,482 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
