...
• Geodnet duplicate-coordinate groups declined from 11 to 8.
• WeatherXM over-capacity cells declined from 288 to 286.
• Geodnet entities on public map declined from 19,616 to 19,604.
• WeatherXM entities on public map rose from 8,492 to 8,498.
...
| Coverage growth | 2 | Helium Mobile, WeatherXM | low |
| Token economics | 2 | Hivemapper | medium |

_Totals: 14 signal(s) across 5/7 networks._
...
- **Geodnet** — exact (lat,lng) duplicate groups: 8 (-3 (-27.3%)) _(high · conf 0.85)_
- **Geodnet** — entities on public map: 19,604 (-12 (-0.1%)) _(low · conf 0.85)_
...
- **WeatherXM** — share of map over capacity: 3.37% (-0.03 pp (-0.8%)) _(low · conf 0.85)_

**Coverage growth**
- **WeatherXM** — entities on public map: 8,498 (+6 (+0.1%)) _(low · conf 0.85)_
- **Helium Mobile** — entities on public map: 54,683 (+1 (+0.0%)) _(low · conf 0.85)_
...
- **Hivemapper** — top-20 SPL share of UI supply: 49.20% (+0.07 pp (+0.1%)) _(low · conf 0.85)_
...
- **Coverage growth** (`growth`) — 2 signal(s) across 2 network(s): Helium Mobile, WeatherXM
...
- **Coverage growth** — public growth signals across Helium Mobile, WeatherXM.
...
- [integrity] exact (lat,lng) duplicate groups: 8 (-3 (-27.3%)) _(high · conf 0.85)_
- [integrity] entities on public map: 19,604 (-12 (-0.1%)) _(low · conf 0.85)_
...
- [growth] entities on public map: 8,498 (+6 (+0.1%)) _(low · conf 0.85)_
- [health] cells over designed capacity: 286 (-2 (-0.7%)) _(low · conf 0.85)_
- [health] share of map over capacity: 3.37% (-0.03 pp (-0.8%)) _(low · conf 0.85)_
...
- [economics] top-20 SPL share of UI supply: 49.20% (+0.07 pp (+0.1%)) _(low · conf 0.85)_
...
- [growth] entities on public map: 54,683 (+1 (+0.0%)) _(low · conf 0.85)_
