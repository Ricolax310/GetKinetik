...
• Geodnet duplicate-coordinate groups rose from 1,007 to 1,008.
• WeatherXM over-capacity cells unchanged at 298.
• Geodnet entities on public map rose from 19,473 to 19,482.
...
- **Geodnet** — 1008 exact (lat,lng) duplicate groups on 19,482 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 1,008 (+1 (+0.1%)) _(low · conf 0.85)_
...
- **DIMO** — Of 158,637 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,444 (19.8%) connect via software/synthetic devices, and 86,571 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Geodnet** — entities on public map: 19,482 (+9 (+0.0%)) _(low · conf 0.85)_
...
### Geodnet
- [integrity] 1008 exact (lat,lng) duplicate groups on 19,482 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] exact (lat,lng) duplicate groups: 1,008 (+1 (+0.1%)) _(low · conf 0.85)_
- [growth] entities on public map: 19,482 (+9 (+0.0%)) _(low · conf 0.85)_
...
### DIMO
- [health] Of 158,637 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,444 (19.8%) connect via software/synthetic devices, and 86,571 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
