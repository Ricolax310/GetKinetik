...
> 2026-06-04 · automated cross-network pipeline · evidence not verdicts
...
Observations span 7 networks — no single network dominates the index.
...
|---|---:|---|---|
| Registry & identity integrity | 9 | Dawn Network, Geodnet, Nodle | medium |
| Network health & capacity | 9 | Grass / Titan, Natix Network, WeatherXM | high |
| Token economics | 1 | Hivemapper | medium |

_Totals: 19 signal(s) across 7/8 networks._

### What Changed Today

**Registry & identity integrity**
- **Geodnet** — 10 exact (lat,lng) duplicate groups on 19,612 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **Natix Network** — KM mapped frozen 33 days at 254,808,022 (no change since 2026-05-01) while registered drivers kept moving (+61 over the same window) — the cumulative coverage counter has stalled even as registrations advance. _(high · conf 0.70)_
- **Natix Network** — top-20 SPL share of UI supply: 72.39% (-0.00 pp (-0.0%)) _(high · conf 0.85)_
- **Natix Network** — days detections at zero: 33 (+1 (+3.1%)) _(high · conf 0.85)_
- **Natix Network** — registered drivers: 271,401 (+1 (+0.0%)) _(high · conf 0.85)_
...
- **Registry & identity integrity** (`integrity`) — 9 signal(s) across 3 network(s): Dawn Network, Geodnet, Nodle
- **Network health & capacity** (`health`) — 9 signal(s) across 3 network(s): Grass / Titan, Natix Network, WeatherXM
...
- **Network health & capacity** — public health signals across Grass / Titan, Natix Network, WeatherXM.
...
### Geodnet
- [integrity] 10 exact (lat,lng) duplicate groups on 19,612 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Natix Network
- [health] KM mapped frozen 33 days at 254,808,022 (no change since 2026-05-01) while registered drivers kept moving (+61 over the same window) — the cumulative coverage counter has stalled even as registrations advance. _(high · conf 0.70)_
- [health] top-20 SPL share of UI supply: 72.39% (-0.00 pp (-0.0%)) _(high · conf 0.85)_
- [health] days detections at zero: 33 (+1 (+3.1%)) _(high · conf 0.85)_
- [health] registered drivers: 271,401 (+1 (+0.0%)) _(high · conf 0.85)_
