...
- **Geodnet** — 6 exact (lat,lng) duplicate groups on 19,577 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,445 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,438 (19.8%) connect via software/synthetic devices, and 86,385 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 6 exact (lat,lng) duplicate groups on 19,577 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,445 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,438 (19.8%) connect via software/synthetic devices, and 86,385 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
