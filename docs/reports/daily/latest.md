...
> 2026-08-18 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups declined from 7 to 6.
• WeatherXM over-capacity cells unchanged at 290.
• Geodnet entities on public map declined from 19,496 to 19,490.
...
- **Geodnet** — entities on public map: 19,490 (-6 (-0.0%)) _(low · conf 0.85)_
...
- **Helium Mobile** — 526 single-coordinate stacks of ≥10 hotspots on 54,915 located units — the largest stack holds 540 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
- **DIMO** — Of 158,542 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,452 (19.8%) connect via software/synthetic devices, and 86,468 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
...
- [integrity] entities on public map: 19,490 (-6 (-0.0%)) _(low · conf 0.85)_
...
### Helium Mobile
- [integrity] 526 single-coordinate stacks of ≥10 hotspots on 54,915 located units — the largest stack holds 540 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_

### DIMO
- [health] Of 158,542 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,452 (19.8%) connect via software/synthetic devices, and 86,468 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
