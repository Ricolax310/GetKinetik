...
> 2026-08-23 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups rose from 6 to 7.
• WeatherXM over-capacity cells rose from 289 to 291.
• Geodnet entities on public map rose from 19,499 to 19,512.
...
- **Geodnet** — 7 exact (lat,lng) duplicate groups on 19,512 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
- **DIMO** — Of 158,568 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,449 (19.8%) connect via software/synthetic devices, and 86,497 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Geodnet** — entities on public map: 19,512 (+13 (+0.1%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 47.85% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 7 exact (lat,lng) duplicate groups on 19,512 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] exact (lat,lng) duplicate groups: 7 (+1 (+16.7%)) _(high · conf 0.85)_
- [growth] entities on public map: 19,512 (+13 (+0.1%)) _(low · conf 0.85)_
...
### Hivemapper
- [economics] 47.85% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,568 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,449 (19.8%) connect via software/synthetic devices, and 86,497 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
