...
• Geodnet duplicate-coordinate groups declined from 1,005 to 1,003.
• WeatherXM over-capacity cells unchanged at 300.
• Geodnet entities on public map declined from 19,509 to 19,495.
...
- **Geodnet** — 1003 exact (lat,lng) duplicate groups on 19,495 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 1,003 (-2 (-0.2%)) _(low · conf 0.85)_
- **Geodnet** — entities on public map: 19,495 (-14 (-0.1%)) _(low · conf 0.85)_
...
- **DIMO** — Of 158,685 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,407 (19.8%) connect via software/synthetic devices, and 86,656 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 1003 exact (lat,lng) duplicate groups on 19,495 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] exact (lat,lng) duplicate groups: 1,003 (-2 (-0.2%)) _(low · conf 0.85)_
- [integrity] entities on public map: 19,495 (-14 (-0.1%)) _(low · conf 0.85)_
...
### DIMO
- [health] Of 158,685 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,407 (19.8%) connect via software/synthetic devices, and 86,656 (54.6%) show no connected device on the public registry. _(medium · conf 0.70)_
