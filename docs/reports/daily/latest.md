...
> 2026-07-13 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups unchanged at 10.
• WeatherXM over-capacity cells unchanged at 289.
• DIMO entities on public map rose from 158,239 to 158,252.
...
- **Geodnet** — 10 exact (lat,lng) duplicate groups on 19,560 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — entities on public map: 19,560 (-9 (-0.0%)) _(low · conf 0.85)_
- **Helium IoT** — 4,859 single-coordinate stacks of ≥10 hotspots on 1,008,113 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
- **DIMO** — Of 158,252 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,416 (19.9%) connect via software/synthetic devices, and 86,214 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **DIMO** — entities on public map: 158,252 (+13 (+0.0%)) _(low · conf 0.85)_
...
### Geodnet
- [integrity] 10 exact (lat,lng) duplicate groups on 19,560 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] entities on public map: 19,560 (-9 (-0.0%)) _(low · conf 0.85)_
...
### Helium IoT
- [integrity] 4,859 single-coordinate stacks of ≥10 hotspots on 1,008,113 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,252 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,416 (19.9%) connect via software/synthetic devices, and 86,214 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
- [growth] entities on public map: 158,252 (+13 (+0.0%)) _(low · conf 0.85)_
