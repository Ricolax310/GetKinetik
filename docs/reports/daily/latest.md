...
• Geodnet entities on public map declined from 19,573 to 19,564.
...
- **Geodnet** — 9 exact (lat,lng) duplicate groups on 19,564 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — entities on public map: 19,564 (-9 (-0.0%)) _(low · conf 0.85)_
...
- **DIMO** — Of 158,194 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,415 (19.9%) connect via software/synthetic devices, and 86,157 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 9 exact (lat,lng) duplicate groups on 19,564 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] entities on public map: 19,564 (-9 (-0.0%)) _(low · conf 0.85)_
...
### DIMO
- [health] Of 158,194 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,415 (19.9%) connect via software/synthetic devices, and 86,157 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
