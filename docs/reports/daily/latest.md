...
> 2026-07-03 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups rose from 7 to 9.
• WeatherXM over-capacity cells unchanged at 288.
• DIMO entities on public map rose from 158,173 to 158,179.
...
- **Geodnet** — 9 exact (lat,lng) duplicate groups on 19,575 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 9 (+2 (+28.6%)) _(high · conf 0.85)_
- **Helium IoT** — 4,861 single-coordinate stacks of ≥10 hotspots on 1,008,089 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
- **Helium IoT** — single-coordinate stacks (≥10 hotspots): 4,861 (+1 (+0.0%)) _(low · conf 0.85)_
- **Helium Mobile** — 530 single-coordinate stacks of ≥10 hotspots on 54,771 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
- **DIMO** — Of 158,179 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,413 (19.9%) connect via software/synthetic devices, and 86,144 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **DIMO** — entities on public map: 158,179 (+6 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 49.04% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 9 exact (lat,lng) duplicate groups on 19,575 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Hivemapper
- [economics] 49.04% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_

### NATIX
- _No qualifying public finding in latest snapshot._

### Helium IoT
- [integrity] 4,861 single-coordinate stacks of ≥10 hotspots on 1,008,089 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
- [integrity] single-coordinate stacks (≥10 hotspots): 4,861 (+1 (+0.0%)) _(low · conf 0.85)_

### Helium Mobile
- [integrity] 530 single-coordinate stacks of ≥10 hotspots on 54,771 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_

### DIMO
- [health] Of 158,179 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,413 (19.9%) connect via software/synthetic devices, and 86,144 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
- [growth] entities on public map: 158,179 (+6 (+0.0%)) _(low · conf 0.85)_
