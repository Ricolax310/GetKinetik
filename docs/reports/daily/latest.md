...
• Geodnet duplicate-coordinate groups rose from 1,008 to 1,009.
...
- **Geodnet** — 1009 exact (lat,lng) duplicate groups on 19,496 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
...
### Geodnet
- [integrity] 1009 exact (lat,lng) duplicate groups on 19,496 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
