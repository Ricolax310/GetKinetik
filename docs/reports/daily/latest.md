...
> 2026-07-11 · automated cross-network pipeline · evidence not verdicts

## Today's Read

• Geodnet duplicate-coordinate groups rose from 9 to 10.
• WeatherXM over-capacity cells rose from 288 to 289.
• Hivemapper visible HONEY concentration rose from 49% to 51% of visible supply.
• Geodnet entities on public map rose from 19,553 to 19,559.
...
- **Geodnet** — 10 exact (lat,lng) duplicate groups on 19,559 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- **Geodnet** — exact (lat,lng) duplicate groups: 10 (+1 (+11.1%)) _(high · conf 0.85)_
- **Helium IoT** — 4,860 single-coordinate stacks of ≥10 hotspots on 1,008,110 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
- **DIMO** — Of 158,229 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,415 (19.9%) connect via software/synthetic devices, and 86,192 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_

**Coverage growth**
- **Geodnet** — entities on public map: 19,559 (+6 (+0.0%)) _(low · conf 0.85)_

**Token economics**
- **Hivemapper** — 50.61% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
- **Hivemapper** — top-20 SPL share of UI supply: 50.61% (+1.54 pp (+3.1%)) _(medium · conf 0.85)_
...
### Geodnet
- [integrity] 10 exact (lat,lng) duplicate groups on 19,559 public stations — each row in §1 is one coordinate pair your registry team can grep today. _(medium · conf 0.70)_
- [integrity] exact (lat,lng) duplicate groups: 10 (+1 (+11.1%)) _(high · conf 0.85)_
- [growth] entities on public map: 19,559 (+6 (+0.0%)) _(low · conf 0.85)_
...
### Hivemapper
- [economics] 50.61% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read. _(medium · conf 0.70)_
- [economics] top-20 SPL share of UI supply: 50.61% (+1.54 pp (+3.1%)) _(medium · conf 0.85)_

### NATIX
- _No qualifying public finding in latest snapshot._

### Helium IoT
- [integrity] 4,860 single-coordinate stacks of ≥10 hotspots on 1,008,110 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today). _(medium · conf 0.70)_
...
### DIMO
- [health] Of 158,229 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,415 (19.9%) connect via software/synthetic devices, and 86,192 (54.5%) show no connected device on the public registry. _(medium · conf 0.70)_
