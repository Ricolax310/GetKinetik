...
- **Geodnet** — exact (lat,lng) duplicate groups: 1,019 (+2 (+0.2%))
- **Hivemapper** — top-20 SPL share of UI supply: 52.26% (-0.37 pp (-0.7%))
- **DIMO** — entities on public map: 158,631 (-30 (-0.0%))
