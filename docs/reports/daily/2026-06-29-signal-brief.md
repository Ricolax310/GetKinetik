...
> 2026-06-29 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• Geodnet duplicate-coordinate groups declined from 9 to 6.
• Geodnet entities on public map rose from 19,575 to 19,582.
• Helium Mobile entities on public map rose from 54,728 to 54,752.
