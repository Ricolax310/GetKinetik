...
> 2026-08-19 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
• WeatherXM over-capacity share unchanged at 3%.
...
- **WeatherXM** — cells over designed capacity: 285 (-5 (-1.7%))
- **WeatherXM** — share of map over capacity: 3.35% (-0.06 pp (-1.8%))
- **Helium Mobile** — entities on public map: 54,964 (+49 (+0.1%))
