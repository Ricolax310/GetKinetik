...
> 2026-06-25 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• Geodnet duplicate-coordinate groups rose from 7 to 8.
• WeatherXM over-capacity cells rose from 285 to 289.
• DIMO entities on public map rose from 158,089 to 158,097.
• Geodnet entities on public map declined from 19,597 to 19,585.
