...
> 2026-09-12 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• WeatherXM over-capacity cells declined from 298 to 297.
• Helium Mobile entities on public map rose from 55,644 to 56,001.
• Helium Mobile flagged fleet share unchanged at 20%.
...
Public read on Geodnet: 1012 exact (lat,lng) duplicate groups on 19,489 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
