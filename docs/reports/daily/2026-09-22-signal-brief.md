...
> 2026-09-22 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **Geodnet** — exact (lat,lng) duplicate groups: 1,002 (-4 (-0.4%))
- **Geodnet** — entities on public map: 19,511 (+7 (+0.0%))
- **WeatherXM** — cells over designed capacity: 299 (-2 (-0.7%))
- **Hivemapper** — top-20 SPL share of UI supply: 52.25% (-0.23 pp (-0.4%))
- **DIMO** — entities on public map: 158,672 (+8 (+0.0%))
