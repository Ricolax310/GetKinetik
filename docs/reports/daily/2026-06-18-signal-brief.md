...
> 2026-06-18 · derived from public audit snapshots only. Signals → report (not narrative-first).

## Today's Read

• Geodnet duplicate-coordinate groups declined from 10 to 9.
• WeatherXM over-capacity cells rose from 284 to 286.
• Helium Mobile single-coordinate hotspot stacks rose from 529 to 530.
...
Public read on Geodnet: 9 exact (lat,lng) duplicate groups on 19,614 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
