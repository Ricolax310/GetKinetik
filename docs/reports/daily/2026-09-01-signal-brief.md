...
> 2026-09-01 · derived from public audit snapshots only. Signals → report (not narrative-first).
...
- **WeatherXM** — entities on public map: 8,566 (+55 (+0.6%))
- **WeatherXM** — cells over designed capacity: 296 (+4 (+1.4%))
- **DIMO** — entities on public map: 158,623 (+7 (+0.0%))
- **Helium IoT** — entities on public map: 1,008,203 (+6 (+0.0%))
- **Hivemapper** — 51.35% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read.
...
Public read on Geodnet: 1001 exact (lat,lng) duplicate groups on 19,476 public stations — each row in §1 is one coordinate pair your registry team can grep today. — does that match your internal view, or is the public feed expected to behave this way?
