...
- Helium IoT: 4,860 single-coordinate stacks of ≥10 hotspots on 1,008,169 located units — the largest stack holds 501 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
- 12 daily signal record(s) in 2026-08.
