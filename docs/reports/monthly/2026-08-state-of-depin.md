...
**Supporting observations**
- Geodnet: 5 exact (lat,lng) duplicate groups on 19,543 public stations — each row in §1 is one coordinate pair your registry team can grep today.
- Geodnet: entities on public map 19,543 (-11 (-0.1%))
- Helium IoT: 4,860 single-coordinate stacks of ≥10 hotspots on 1,008,171 located units — the largest stack holds 501 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
### Geodnet
- 5 exact (lat,lng) duplicate groups on 19,543 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
### DIMO
- Of 158,490 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,437 (19.8%) connect via software/synthetic devices, and 86,431 (54.5%) show no connected device on the public registry.
...
- 13 daily signal record(s) in 2026-08.
