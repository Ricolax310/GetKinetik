...
- Helium IoT: 4,860 single-coordinate stacks of ≥10 hotspots on 1,008,167 located units — the largest stack holds 501 hotspots on one coordinate (§1 lists keys your registry team can grep today).
- Helium IoT: largest single-coordinate stack 501 (-1 (-0.2%))
- Helium Mobile: 526 single-coordinate stacks of ≥10 hotspots on 54,910 located units — the largest stack holds 540 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
### Geodnet
- 6 exact (lat,lng) duplicate groups on 19,566 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
### DIMO
- Of 158,469 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,437 (19.8%) connect via software/synthetic devices, and 86,410 (54.5%) show no connected device on the public registry.

### Helium IoT
- 4,860 single-coordinate stacks of ≥10 hotspots on 1,008,167 located units — the largest stack holds 501 hotspots on one coordinate (§1 lists keys your registry team can grep today).

### Helium Mobile
- 526 single-coordinate stacks of ≥10 hotspots on 54,910 located units — the largest stack holds 540 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
- 11 daily signal record(s) in 2026-08.
