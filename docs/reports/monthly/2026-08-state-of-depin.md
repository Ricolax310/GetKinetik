...
**Supporting observations**
- Geodnet: 7 exact (lat,lng) duplicate groups on 19,514 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
- 23 daily signal record(s) in 2026-08.
