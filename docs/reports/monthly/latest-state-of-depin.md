...
_Latest reading: 2026-08-19_

- **Geodnet** — exact (lat,lng) duplicate groups: 7 (+2 (+40.0%))
- **WeatherXM** — cells over designed capacity: 288 (+3 (+1.1%))
...
**Supporting observations**
- Geodnet: 7 exact (lat,lng) duplicate groups on 19,484 public stations — each row in §1 is one coordinate pair your registry team can grep today.
- Geodnet: exact (lat,lng) duplicate groups 7 (+2 (+40.0%))
...
- Helium Mobile: 526 single-coordinate stacks of ≥10 hotspots on 54,964 located units — the largest stack holds 540 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
### Geodnet
- 7 exact (lat,lng) duplicate groups on 19,484 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
### DIMO
- Of 158,543 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware; 31,451 (19.8%) connect via software/synthetic devices, and 86,470 (54.5%) show no connected device on the public registry.
...
### Helium Mobile
- 526 single-coordinate stacks of ≥10 hotspots on 54,964 located units — the largest stack holds 540 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
- 19 daily signal record(s) in 2026-08.
