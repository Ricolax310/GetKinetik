...
_Latest reading: 2026-06-25_

- **Geodnet** — exact (lat,lng) duplicate groups: 8 (+1 (+14.3%))
- **Geodnet** — entities on public map: 19,585 (-12 (-0.1%))
- **WeatherXM** — cells over designed capacity: 289 (+4 (+1.4%))
- **DIMO** — entities on public map: 158,097 (+8 (+0.0%))
...
**Supporting observations**
- Geodnet: 8 exact (lat,lng) duplicate groups on 19,585 public stations — each row in §1 is one coordinate pair your registry team can grep today.
- Geodnet: exact (lat,lng) duplicate groups 8 (+1 (+14.3%))
- Geodnet: entities on public map 19,585 (-12 (-0.1%))
- Helium IoT: 4,859 single-coordinate stacks of ≥10 hotspots on 1,008,065 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today).
- Helium IoT: single-coordinate stacks (≥10 hotspots) 4,859 (+1 (+0.0%))
- Helium Mobile: 531 single-coordinate stacks of ≥10 hotspots on 54,723 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
**Supporting observations**
- Hivemapper: 49.11% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read.
...
### Geodnet
- 8 exact (lat,lng) duplicate groups on 19,585 public stations — each row in §1 is one coordinate pair your registry team can grep today.

### Hivemapper
- 49.11% of UI-reported HONEY sits in the top 20 visible SPL accounts (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read.

### DIMO
- Of 158,097 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,383 (19.9%) connect via software/synthetic devices, and 86,092 (54.5%) show no connected device on the public registry.

### Helium IoT
- 4,859 single-coordinate stacks of ≥10 hotspots on 1,008,065 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today).

### Helium Mobile
- 531 single-coordinate stacks of ≥10 hotspots on 54,723 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
- 23 daily signal record(s) in 2026-06.
