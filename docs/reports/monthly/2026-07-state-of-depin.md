...
**Supporting observations**
- Geodnet: 9 exact (lat,lng) duplicate groups on 19,589 public stations — each row in §1 is one coordinate pair your registry team can grep today.
- Geodnet: exact (lat,lng) duplicate groups 9 (+1 (+12.5%))
- Helium IoT: 4,858 single-coordinate stacks of ≥10 hotspots on 1,008,128 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today).
- Helium Mobile: 528 single-coordinate stacks of ≥10 hotspots on 54,856 located units — the largest stack holds 498 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
### Geodnet
- 9 exact (lat,lng) duplicate groups on 19,589 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
### DIMO
- Of 158,361 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware; 31,420 (19.8%) connect via software/synthetic devices, and 86,319 (54.5%) show no connected device on the public registry.

### Helium IoT
- 4,858 single-coordinate stacks of ≥10 hotspots on 1,008,128 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today).

### Helium Mobile
- 528 single-coordinate stacks of ≥10 hotspots on 54,856 located units — the largest stack holds 498 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
- 24 daily signal record(s) in 2026-07.
