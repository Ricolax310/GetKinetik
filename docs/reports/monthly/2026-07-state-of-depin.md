...
**Supporting observations**
- Geodnet: 8 exact (lat,lng) duplicate groups on 19,572 public stations — each row in §1 is one coordinate pair your registry team can grep today.
- Geodnet: exact (lat,lng) duplicate groups 8 (-1 (-11.1%))
- Helium IoT: 4,861 single-coordinate stacks of ≥10 hotspots on 1,008,090 located units — the largest stack holds 502 hotspots on one coordinate (§1 lists keys your registry team can grep today).
- Helium Mobile: 530 single-coordinate stacks of ≥10 hotspots on 54,771 located units — the largest stack holds 497 hotspots on one coordinate (§1 lists keys your registry team can grep today).
...
### Geodnet
- 8 exact (lat,lng) duplicate groups on 19,572 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
- 3 daily signal record(s) in 2026-07.
