...
- **Hotspots observed (with coordinates):** 54,719
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,270 (20.60%)

## Executive summary

1. **531 single-coordinate stacks of ≥10 hotspots** on 54,719 located units — the largest stack holds **497 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 54,719 | unchanged vs last run |
| Single-coordinate stacks (≥10 hotspots) | 531 | unchanged vs last run |
| Largest single-coordinate stack | 497 | unchanged vs last run |
| Fleet share flagged (any heuristic) | 20.60% | unchanged vs last run |
