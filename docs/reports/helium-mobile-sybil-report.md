...
- **Hotspots observed (with coordinates):** 54,869
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,271 (20.54%)

## Executive summary

1. **528 single-coordinate stacks of ≥10 hotspots** on 54,869 located units — the largest stack holds **497 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 54,869 | unchanged vs last run |
