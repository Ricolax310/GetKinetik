...
- **Hotspots observed (with coordinates):** 54,864
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,272 (20.55%)

## Executive summary

1. **528 single-coordinate stacks of ≥10 hotspots** on 54,864 located units — the largest stack holds **498 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 54,864 | unchanged vs last run |
| Single-coordinate stacks (≥10 hotspots) | 528 | unchanged vs last run |
| Largest single-coordinate stack | 498 | unchanged vs last run |
