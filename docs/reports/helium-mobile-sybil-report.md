...
- **Hotspots observed (with coordinates):** 55,549
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,318 (20.37%)

## Executive summary

1. **529 single-coordinate stacks of ≥10 hotspots** on 55,549 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 55,549 | unchanged vs last run |
| Single-coordinate stacks (≥10 hotspots) | 529 | unchanged vs last run |
| Largest single-coordinate stack | 540 | unchanged vs last run |
| Fleet share flagged (any heuristic) | 20.37% | unchanged vs last run |
