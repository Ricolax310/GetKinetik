...
- **Hotspots observed (with coordinates):** 56,003
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,342 (20.25%)

## Executive summary

1. **531 single-coordinate stacks of ≥10 hotspots** on 56,003 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 56,003 | unchanged vs last run |
