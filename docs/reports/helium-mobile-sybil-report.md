...
- **Hotspots observed (with coordinates):** 55,589
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,319 (20.36%)

## Executive summary

1. **529 single-coordinate stacks of ≥10 hotspots** on 55,589 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 55,589 | unchanged vs last run |
