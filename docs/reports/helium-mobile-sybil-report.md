...
- **Hotspots flagged (any heuristic):** 11,330 (20.38%)

## Executive summary

1. **530 single-coordinate stacks of ≥10 hotspots** on 55,595 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
