...
1. **529 single-coordinate stacks of ≥10 hotspots** on 55,590 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 55,590 | unchanged vs last run |
