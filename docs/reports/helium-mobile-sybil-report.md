...
- **Hotspots observed (with coordinates):** 54,965
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,280 (20.52%)

## Executive summary

1. **526 single-coordinate stacks of ≥10 hotspots** on 54,965 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 54,965 | unchanged vs last run |
| Single-coordinate stacks (≥10 hotspots) | 526 | unchanged vs last run |
| Largest single-coordinate stack | 540 | unchanged vs last run |
| Fleet share flagged (any heuristic) | 20.52% | unchanged vs last run |
