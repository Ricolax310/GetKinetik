...
- **Hotspots observed (with coordinates):** 56,001
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,343 (20.25%)

## Executive summary

1. **531 single-coordinate stacks of ≥10 hotspots** on 56,001 located units — the largest stack holds **540 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 56,001 | +357 (+0.6%) |
