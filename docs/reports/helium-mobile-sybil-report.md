...
- **Hotspots observed (with coordinates):** 54,861
- **Hotspots without asserted location:** 1,903
- **Hotspots flagged (any heuristic):** 11,273 (20.55%)

## Executive summary

1. **528 single-coordinate stacks of ≥10 hotspots** on 54,861 located units — the largest stack holds **498 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 54,861 | +3 (+0.0%) |
