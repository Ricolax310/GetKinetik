...
- **Vehicle identities:** 158,653
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,423 (19.8%)
- **Vehicle identities with no connected device:** 86,608 (54.6%)

---

## Executive summary

1. **Of 158,653 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,423 (19.8%) connect via software/synthetic devices, and 86,608 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,653 | unchanged vs last run |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,423 | unchanged vs last run |
| Share backed by hardware | 25.60% | unchanged vs last run |
| Share with no connected device | 54.59% | unchanged vs last run |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,653 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,423 | 19.8% |
| Any connected device | 72,045 | 45.4% |
| No connected device on registry | 86,608 | 54.6% |
