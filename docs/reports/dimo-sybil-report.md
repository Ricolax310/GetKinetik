...
- **Vehicle identities:** 158,631
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,430 (19.8%)
- **Vehicle identities with no connected device:** 86,579 (54.6%)

---

## Executive summary

1. **Of 158,631 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,430 (19.8%) connect via software/synthetic devices, and 86,579 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,631 | unchanged vs last run |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,430 | +1 (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,631 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,430 | 19.8% |
| Any connected device | 72,052 | 45.4% |
| No connected device on registry | 86,579 | 54.6% |
