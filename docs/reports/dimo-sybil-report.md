...
- **Vehicle identities with no connected device:** 86,596 (54.6%)

---

## Executive summary

1. **Of 158,643 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,425 (19.8%) connect via software/synthetic devices, and 86,596 (54.6%) show no connected device on the public registry.
...
| Software / synthetic devices | 31,425 | 19.8% |
| Any connected device | 72,047 | 45.4% |
| No connected device on registry | 86,596 | 54.6% |
