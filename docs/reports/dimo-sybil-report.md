...
- **Vehicle identities with no connected device:** 86,571 (54.6%)

---

## Executive summary

1. **Of 158,640 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,447 (19.8%) connect via software/synthetic devices, and 86,571 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,640 | +3 (+0.0%) |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,447 | unchanged vs last run |
...
| No connected device on registry | 86,571 | 54.6% |
