...
- **Software/synthetic devices:** 31,427 (19.8%)
- **Vehicle identities with no connected device:** 86,339 (54.5%)

---

## Executive summary

1. **Of 158,388 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,427 (19.8%) connect via software/synthetic devices, and 86,339 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,388 | unchanged vs last run |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,427 | +3 (+0.0%) |
...
| Software / synthetic devices | 31,427 | 19.8% |
| Any connected device | 72,049 | 45.5% |
| No connected device on registry | 86,339 | 54.5% |
