...
1. **Of 158,637 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,444 (19.8%) connect via software/synthetic devices, and 86,571 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,637 | -2 (-0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,637 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,444 | 19.8% |
| Any connected device | 72,066 | 45.4% |
