...
- **Vehicle identities:** 158,633
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,448 (19.8%)
- **Vehicle identities with no connected device:** 86,563 (54.6%)

---

## Executive summary

1. **Of 158,633 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,448 (19.8%) connect via software/synthetic devices, and 86,563 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,633 | +2 (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,633 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,448 | 19.8% |
| Any connected device | 72,070 | 45.4% |
| No connected device on registry | 86,563 | 54.6% |
