...
- **Vehicle identities:** 158,087
- **Physical hardware devices (aftermarket):** 40,622 (25.7%)
- **Software/synthetic devices:** 31,379 (19.8%)
...
1. **Of 158,087 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware**; 31,379 (19.8%) connect via software/synthetic devices, and 86,086 (54.5%) show no connected device on the public registry.
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,087 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.7% |
| Software / synthetic devices | 31,379 | 19.8% |
| Any connected device | 72,001 | 45.5% |
