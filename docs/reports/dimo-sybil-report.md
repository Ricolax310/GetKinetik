...
- **Vehicle identities:** 158,658
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,443 (19.8%)
- **Vehicle identities with no connected device:** 86,593 (54.6%)

---

## Executive summary

1. **Of 158,658 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,443 (19.8%) connect via software/synthetic devices, and 86,593 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,658 | +2 (+0.0%) |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,443 | unchanged vs last run |
| Share backed by hardware | 25.60% | -0.00 pp (-0.0%) |
| Share with no connected device | 54.58% | +0.00 pp (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,658 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,443 | 19.8% |
| Any connected device | 72,065 | 45.4% |
| No connected device on registry | 86,593 | 54.6% |
