...
- **Vehicle identities:** 158,657
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,442 (19.8%)
...
1. **Of 158,657 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,442 (19.8%) connect via software/synthetic devices, and 86,593 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,657 | +1 (+0.0%) |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,442 | unchanged vs last run |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,657 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,442 | 19.8% |
| Any connected device | 72,064 | 45.4% |
