...
- **Vehicle identities:** 158,520
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,444 (19.8%)
- **Vehicle identities with no connected device:** 86,454 (54.5%)

---

## Executive summary

1. **Of 158,520 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,444 (19.8%) connect via software/synthetic devices, and 86,454 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,520 | unchanged vs last run |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,444 | unchanged vs last run |
| Share backed by hardware | 25.63% | unchanged vs last run |
| Share with no connected device | 54.54% | unchanged vs last run |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,520 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,444 | 19.8% |
| Any connected device | 72,066 | 45.5% |
| No connected device on registry | 86,454 | 54.5% |
