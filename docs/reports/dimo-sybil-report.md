...
- **Vehicle identities:** 158,252
- **Physical hardware devices (aftermarket):** 40,622 (25.7%)
- **Software/synthetic devices:** 31,416 (19.9%)
- **Vehicle identities with no connected device:** 86,214 (54.5%)

---

## Executive summary

1. **Of 158,252 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware**; 31,416 (19.9%) connect via software/synthetic devices, and 86,214 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,252 | +13 (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,252 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.7% |
| Software / synthetic devices | 31,416 | 19.9% |
| Any connected device | 72,038 | 45.5% |
| No connected device on registry | 86,214 | 54.5% |
