...
- **Vehicle identities:** 158,375
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,424 (19.8%)
- **Vehicle identities with no connected device:** 86,329 (54.5%)

---

## Executive summary

1. **Of 158,375 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,424 (19.8%) connect via software/synthetic devices, and 86,329 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,375 | +1 (+0.0%) |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,424 | unchanged vs last run |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,375 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,424 | 19.8% |
| Any connected device | 72,046 | 45.5% |
| No connected device on registry | 86,329 | 54.5% |
