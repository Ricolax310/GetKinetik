...
- **Vehicle identities:** 158,301
- **Physical hardware devices (aftermarket):** 40,622 (25.7%)
- **Software/synthetic devices:** 31,417 (19.8%)
- **Vehicle identities with no connected device:** 86,262 (54.5%)

---

## Executive summary

1. **Of 158,301 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware**; 31,417 (19.8%) connect via software/synthetic devices, and 86,262 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,301 | +2 (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,301 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.7% |
| Software / synthetic devices | 31,417 | 19.8% |
| Any connected device | 72,039 | 45.5% |
| No connected device on registry | 86,262 | 54.5% |
