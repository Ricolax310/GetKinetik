...
- **Vehicle identities:** 158,640
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,442 (19.8%)
- **Vehicle identities with no connected device:** 86,576 (54.6%)

---

## Executive summary

1. **Of 158,640 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,442 (19.8%) connect via software/synthetic devices, and 86,576 (54.6%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,640 | +5 (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,640 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,442 | 19.8% |
| Any connected device | 72,064 | 45.4% |
| No connected device on registry | 86,576 | 54.6% |
