...
- **Vehicle identities:** 158,469
- **Physical hardware devices (aftermarket):** 40,622 (25.6%)
- **Software/synthetic devices:** 31,437 (19.8%)
- **Vehicle identities with no connected device:** 86,410 (54.5%)

---

## Executive summary

1. **Of 158,469 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,437 (19.8%) connect via software/synthetic devices, and 86,410 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,469 | +2 (+0.0%) |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,437 | unchanged vs last run |
| Share backed by hardware | 25.63% | -0.00 pp (-0.0%) |
| Share with no connected device | 54.53% | +0.00 pp (+0.0%) |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,469 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,437 | 19.8% |
| Any connected device | 72,059 | 45.5% |
| No connected device on registry | 86,410 | 54.5% |
