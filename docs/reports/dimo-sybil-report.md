...
- **Software/synthetic devices:** 31,421 (19.8%)
- **Vehicle identities with no connected device:** 86,614 (54.6%)

---

## Executive summary

1. **Of 158,657 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,421 (19.8%) connect via software/synthetic devices, and 86,614 (54.6%) show no connected device on the public registry.
...
| Software/synthetic devices | 31,421 | unchanged vs last run |
| Share backed by hardware | 25.60% | +0.00 pp (+0.0%) |
| Share with no connected device | 54.59% | -0.00 pp (-0.0%) |
...
| Software / synthetic devices | 31,421 | 19.8% |
| Any connected device | 72,043 | 45.4% |
| No connected device on registry | 86,614 | 54.6% |
