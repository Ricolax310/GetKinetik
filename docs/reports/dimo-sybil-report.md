...
- **Vehicle identities:** 158,223
- **Physical hardware devices (aftermarket):** 40,622 (25.7%)
- **Software/synthetic devices:** 31,420 (19.9%)
- **Vehicle identities with no connected device:** 86,181 (54.5%)

---

## Executive summary

1. **Of 158,223 DIMO vehicle identities, 40,622 (25.7%) are backed by physical hardware**; 31,420 (19.9%) connect via software/synthetic devices, and 86,181 (54.5%) show no connected device on the public registry.
...
|---|---:|---|
| Vehicle identities minted | 158,223 | unchanged vs last run |
| Physical hardware devices | 40,622 | unchanged vs last run |
| Software/synthetic devices | 31,420 | unchanged vs last run |
| Share backed by hardware | 25.67% | unchanged vs last run |
| Share with no connected device | 54.47% | unchanged vs last run |
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,223 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.7% |
| Software / synthetic devices | 31,420 | 19.9% |
| Any connected device | 72,042 | 45.5% |
| No connected device on registry | 86,181 | 54.5% |
