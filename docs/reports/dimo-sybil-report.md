...
1. **Of 158,615 DIMO vehicle identities, 40,622 (25.6%) are backed by physical hardware**; 31,450 (19.8%) connect via software/synthetic devices, and 86,543 (54.6%) show no connected device on the public registry.
...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,615 | 100% |
