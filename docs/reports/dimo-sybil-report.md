...
|---|---:|---:|
| Vehicle identities (on-chain) | 158,569 | 100% |
| Physical hardware (aftermarket devices) | 40,622 | 25.6% |
| Software / synthetic devices | 31,449 | 19.8% |
| Any connected device | 72,071 | 45.5% |
| No connected device on registry | 86,498 | 54.5% |
