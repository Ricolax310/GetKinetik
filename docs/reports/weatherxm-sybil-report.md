...
- **Devices observed inside drilled cells:** 284

## Executive summary

1. **287 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **106 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **132** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,495 | -3 (-0.0%) |
| Cells ≥1.5× capacity | 287 | -2 (-0.7%) |
| Share of map over capacity | 3.38% | -0.02 pp (-0.7%) |
| `NO_LOCATION_DATA` in drilled set | 106 | +15 (+16.5%) |
| Devices with qod < 30 (drilled) | 132 | +19 (+16.8%) |
...
2. Of the 284 devices inside the most over-capacity cells, **106** are flagged with `pol_reason: NO_LOCATION_DATA` and **10** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **137** of those devices are inactive yet still counted in the cell, and **132** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 3 | 24 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 10 | 71 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 8 | 93 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 98 | 40.5993, 22.9849 |
| `873933759ffffff` | 8 | 1 | 8.0× | 6 | 92 | 38.7867, -9.1042 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 95 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | 1 | 19.2644, -99.0158 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 94 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 56 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 99 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 83 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 54 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 82 | 47.1792, 27.5966 |
...
| `871969046ffffff` | 4 | 1 | 4.0× | 3 | 97 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 90 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 78 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 30 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 5 | 75 | 37.9821, 23.6894 |
...
|---|---:|
| `NO_LOCATION_DATA` | 106 |
| `QOD_THRESHOLD_NOT_REACHED` | 10 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 51 | — | WS1001/WG1200 | 2026-06-25T22:21:00-05:00 |
...
| `2e198990-438d-11ef-8e8d-b55568dc8e66` | N | 33 | — | WS1001/WG1200 | 2026-06-26T03:50:00-05:00 |
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 1 | — | WS1001/WG1200 | 2026-06-25T12:20:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 13 | — | WS1001/WG1200 | 2026-06-25T23:52:00-05:00 |
...
| `fe601050-963e-11ec-900c-abdec1c57354` | Y | 66 | — | WS1000/WG1000 | 2026-06-26T17:51:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-06-26T17:50:33+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | Y | 71 | — | WS1000/WG1000 | 2026-06-26T17:51:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-06-26T17:49:21+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 99 | — | WS2000/WS2000 | 2026-06-26T10:51:28-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 69 | — | WS2000/WS2000 | 2026-06-26T10:51:02-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-06-26T10:49:46-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-06-26T10:51:20-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 88 | — | WS2000/WS2000 | 2026-06-26T10:49:46-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 93 | — | WS1001/WG1200 | 2026-06-26T10:52:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-06-26T10:52:12-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-06-26T10:52:15-04:00 |
