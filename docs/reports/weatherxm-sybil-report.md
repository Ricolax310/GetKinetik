...
- **Cells over designed capacity (≥1.5× capacity):** 299 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 271

## Executive summary

1. **299 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **155 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **153** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,571 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 299 | +1 (+0.3%) |
| Share of map over capacity | 3.49% | +0.01 pp (+0.3%) |
| `NO_LOCATION_DATA` in drilled set | 155 | +26 (+20.2%) |
| Devices with qod < 30 (drilled) | 153 | +23 (+17.7%) |
...
1. **299 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 271 devices inside the most over-capacity cells, **155** are flagged with `pol_reason: NO_LOCATION_DATA` and **3** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **138** of those devices are inactive yet still counted in the cell, and **153** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 41 | 3 | 13.7× | 8 | 79 | 37.9810, 23.7195 |
...
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 90 | 38.7867, -9.1042 |
...
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 77 | 46.3285, 23.7291 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 100 | — | WS1001/WG1200 | 2026-09-16T20:51:13+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-09-16T20:50:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-09-16T20:51:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-27T09:14:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-09-16T20:49:14+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-09-16T20:51:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-16T20:52:00+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-16T20:49:38+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 66 | — | WS1000/WG1000 | 2026-09-16T20:51:00+03:00 |
