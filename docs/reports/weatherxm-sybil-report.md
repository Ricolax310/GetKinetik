...
- **Devices observed inside drilled cells:** 266
...
3. **145** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,503 | +2 (+0.0%) |
| Cells ≥1.5× capacity | 287 | -1 (-0.3%) |
| Share of map over capacity | 3.38% | -0.01 pp (-0.4%) |
| `NO_LOCATION_DATA` in drilled set | 127 | -3 (-2.3%) |
| Devices with qod < 30 (drilled) | 145 | +2 (+1.4%) |
...
2. Of the 266 devices inside the most over-capacity cells, **127** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **140** of those devices are inactive yet still counted in the cell, and **145** have `qod_score < 30`.
...
| `871eda743ffffff` | 28 | 3 | 9.3× | 7 | 69 | 37.9810, 23.7195 |
...
| `871eda742ffffff` | 7 | 2 | 3.5× | 4 | 61 | 37.9821, 23.6894 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-07-29T17:45:13+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 60 | — | WS1001/WG3000 | 2026-07-29T17:22:12+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 91 | — | WS2000/WS2000 | 2026-07-29T10:45:13-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 68 | — | WS2000/WS2000 | 2026-07-29T10:44:18-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 92 | — | WS2000/WS2000 | 2026-07-29T10:42:56-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 80 | — | WS2000/WS2000 | 2026-07-29T10:44:13-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 84 | — | WS1001/WG1200 | 2026-07-29T10:45:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 92 | — | WS2000/WS2000 | 2026-07-29T10:42:51-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 91 | — | WS2000/WS2000 | 2026-07-29T10:45:16-04:00 |
