...
|---|---:|---|
| Cells on public map | 8,571 | unchanged vs last run |
| Cells ≥1.5× capacity | 298 | unchanged vs last run |
| Share of map over capacity | 3.48% | unchanged vs last run |
| `NO_LOCATION_DATA` in drilled set | 135 | -24 (-15.1%) |
| Devices with qod < 30 (drilled) | 138 | -25 (-15.3%) |
...
2. Of the 220 devices inside the most over-capacity cells, **135** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **120** of those devices are inactive yet still counted in the cell, and **138** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 41 | 3 | 13.7× | 9 | 62 | 37.9810, 23.7195 |
...
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 87 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 85 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 84 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | null | 19.2644, -99.0158 |
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 89 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 87 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 5 | 61 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 99 | 48.5924, 9.1617 |
| `8726c35a9ffffff` | 5 | 1 | 5.0× | 3 | 80 | 34.8702, -99.5157 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 8 | 21 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 7 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 1 | null | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 68 | 40.2933, -75.7373 |
...
| `e0108150-a554-11f1-9fa2-d9b3427c596a` | Y | 2 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-09T20:02:33+03:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-10T20:22:05+03:00 |
| `73adf6d0-a619-11f1-9fa2-d9b3427c596a` | Y | 5 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-09T20:03:36+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 84 | — | WS2000/WS2000 | 2026-09-10T13:23:39-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 64 | — | WS2000/WS2000 | 2026-09-10T13:21:17-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 84 | — | WS2000/WS2000 | 2026-09-10T13:22:19-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 97 | — | WS2000/WS2000 | 2026-09-10T13:21:22-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 87 | — | WS2000/WS2000 | 2026-09-10T13:23:01-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-09-10T13:23:54-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 98 | — | WS2000/WS2000 | 2026-09-10T13:22:12-04:00 |
