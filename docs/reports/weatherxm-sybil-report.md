...
- **Cells observed:** 8,583
- **Cells over designed capacity (≥1.5× capacity):** 300 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 317

## Executive summary

1. **300 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **188 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **188** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,583 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 300 | unchanged vs last run |
| Share of map over capacity | 3.50% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 188 | +51 (+37.2%) |
| Devices with qod < 30 (drilled) | 188 | +45 (+31.5%) |
...
2. Of the 317 devices inside the most over-capacity cells, **188** are flagged with `pol_reason: NO_LOCATION_DATA` and **4** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **171** of those devices are inactive yet still counted in the cell, and **188** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 43 | 3 | 14.3× | 11 | 76 | 37.9810, 23.7195 |
...
| `872aae2cdffffff` | 7 | 1 | 7.0× | 5 | 88 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 6 | 98 | 40.5993, 22.9849 |
...
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 83 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 1 | 64 | 30.8796, -88.3141 |
...
| `877a6ac76ffffff` | 8 | 2 | 4.0× | 8 | 55 | -0.6674, 36.3085 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-25T21:08:14+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-09-25T14:08:18-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 64 | — | WS2000/WS2000 | 2026-09-25T14:08:42-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-09-25T14:07:23-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-09-25T14:06:35-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 94 | — | WS2000/WS2000 | 2026-09-25T14:07:59-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-25T14:08:21-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-09-25T14:07:10-04:00 |
