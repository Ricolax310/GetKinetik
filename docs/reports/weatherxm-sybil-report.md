...
- **Devices observed inside drilled cells:** 193

## Executive summary

1. **289 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **95 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **108** drilled devices sit below qod 30 while still counted toward cell saturation.
...
| `NO_LOCATION_DATA` in drilled set | 95 | -7 (-6.9%) |
| Devices with qod < 30 (drilled) | 108 | -10 (-8.5%) |
...
2. Of the 193 devices inside the most over-capacity cells, **95** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **109** of those devices are inactive yet still counted in the cell, and **108** have `qod_score < 30`.
...
| `871eda743ffffff` | 27 | 3 | 9.0× | 6 | 92 | 37.9810, 23.7195 |
...
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 97 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 56 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 4 | 81 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 89 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 56 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 63 | 47.1792, 27.5966 |
...
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 88 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 75 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 48 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 5 | 64 | 37.9821, 23.6894 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 62 | 40.9919, 29.0488 |
| `8728f00c0ffffff` | 7 | 2 | 3.5× | 3 | 47 | 45.6894, -122.6790 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 97 | — | WS1001/WG1200 | 2026-07-13T17:54:02+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 97 | — | WS1001/WG3000 | 2026-07-13T17:23:11+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-13T10:55:42-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 65 | — | WS2000/WS2000 | 2026-07-13T10:56:09-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-07-13T10:57:10-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-13T10:55:09-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 88 | — | WS2000/WS2000 | 2026-07-13T10:56:18-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 62 | — | WS1001/WG1200 | 2026-07-13T10:57:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-07-13T10:56:01-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-07-13T10:57:18-04:00 |
