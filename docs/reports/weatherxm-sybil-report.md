...
- **Cells observed:** 8,500
- **Cells over designed capacity (≥1.5× capacity):** 287 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 207

## Executive summary

1. **287 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **113 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **123** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,500 | +6 (+0.1%) |
| Cells ≥1.5× capacity | 287 | +1 (+0.3%) |
| Share of map over capacity | 3.38% | +0.01 pp (+0.3%) |
| `NO_LOCATION_DATA` in drilled set | 113 | +7 (+6.6%) |
| Devices with qod < 30 (drilled) | 123 | +7 (+6.0%) |
...
2. Of the 207 devices inside the most over-capacity cells, **113** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **115** of those devices are inactive yet still counted in the cell, and **123** have `qod_score < 30`.
...
| `871eda743ffffff` | 29 | 3 | 9.7× | 8 | 93 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 8 | 87 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 100 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 7 | 71 | 40.5993, 22.9849 |
...
| `871faa694ffffff` | 5 | 1 | 5.0× | 4 | 98 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 88 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 57 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 5 | 64 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 21 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 65 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 2 | 76 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 82 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 80 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 0 | 1 | 19.2595, -99.0815 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-07-23T17:42:24+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-07-23T17:27:23+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-07-23T10:42:58-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 60 | — | WS2000/WS2000 | 2026-07-23T10:41:30-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 98 | — | WS2000/WS2000 | 2026-07-23T10:42:56-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-07-23T10:43:43-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 85 | — | WS2000/WS2000 | 2026-07-23T10:41:58-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 62 | — | WS1001/WG1200 | 2026-07-23T10:43:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 98 | — | WS2000/WS2000 | 2026-07-23T10:43:29-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 98 | — | WS2000/WS2000 | 2026-07-23T10:42:59-04:00 |
