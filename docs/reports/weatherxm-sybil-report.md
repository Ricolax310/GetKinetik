...
- **Cells observed:** 8,489
- **Cells over designed capacity (≥1.5× capacity):** 289 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 115

## Executive summary

1. **289 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **67 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **71** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,489 | +1 (+0.0%) |
| Cells ≥1.5× capacity | 289 | +1 (+0.3%) |
| Share of map over capacity | 3.40% | +0.01 pp (+0.3%) |
| `NO_LOCATION_DATA` in drilled set | 67 | -12 (-15.2%) |
| Devices with qod < 30 (drilled) | 71 | -30 (-29.7%) |
...
1. **289 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 115 devices inside the most over-capacity cells, **67** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **71** of those devices are inactive yet still counted in the cell, and **71** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 1 | 42 | 33.8746, -94.8049 |
| `871eda743ffffff` | 29 | 3 | 9.7× | 6 | 94 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 45 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 99 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 7 | 99 | 40.5993, 22.9849 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 85 | 30.8796, -88.3141 |
| `873933759ffffff` | 5 | 1 | 5.0× | 2 | 56 | 38.7867, -9.1042 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 97 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 3 | 88 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 0 | 55 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 4 | 85 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 56 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 27 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 71 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 4 | 95 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 0 | 6 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 0 | null | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 2 | 28 | 40.9919, 29.0488 |
| `8728f00c0ffffff` | 7 | 2 | 3.5× | 2 | 1 | 45.6894, -122.6790 |
...
| `33fe5390-438d-11ef-8e8d-b55568dc8e66` | N | 54 | — | WS1001/WG1200 | 2026-05-25T00:28:00-05:00 |
...
### 3. Cell `871eda743ffffff` — 29 devices in capacity 3 (9.7×)
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-05-25T18:12:26+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-05-25T17:45:19+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 97 | — | WS2000/WS2000 | 2026-05-25T11:13:31-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 96 | — | WS2000/WS2000 | 2026-05-25T11:11:28-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-05-25T11:13:22-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 97 | — | WS2000/WS2000 | 2026-05-25T11:11:06-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 89 | — | WS2000/WS2000 | 2026-05-25T11:12:26-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-04-09T20:23:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-05-25T11:11:00-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 97 | — | WS2000/WS2000 | 2026-05-25T11:13:22-04:00 |
