...
- **Devices observed inside drilled cells:** 338

## Executive summary

1. **298 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **197 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **202** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,575 | +2 (+0.0%) |
| Cells ≥1.5× capacity | 298 | +1 (+0.3%) |
| Share of map over capacity | 3.48% | +0.01 pp (+0.3%) |
| `NO_LOCATION_DATA` in drilled set | 197 | +31 (+18.7%) |
| Devices with qod < 30 (drilled) | 202 | +33 (+19.5%) |
...
2. Of the 338 devices inside the most over-capacity cells, **197** are flagged with `pol_reason: NO_LOCATION_DATA` and **3** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **187** of those devices are inactive yet still counted in the cell, and **202** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 41 | 3 | 13.7× | 8 | 69 | 37.9810, 23.7195 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 1 | 30 | 30.8796, -88.3141 |
...
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 80 | 47.1792, 27.5966 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-13T20:06:19+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 83 | — | WS2000/WS2000 | 2026-09-13T13:08:04-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 57 | — | WS2000/WS2000 | 2026-09-13T13:07:08-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-09-13T13:07:22-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 87 | — | WS2000/WS2000 | 2026-09-13T13:06:00-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-09-13T13:08:10-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 97 | — | WS2000/WS2000 | 2026-09-13T13:08:14-04:00 |
