...
> Independent scan generated by the GETKINETIK Bureau using only the WeatherXM Network's public API. No internal WeatherXM data was used. Findings below are *shape*, not allegations; the underlying signals (capacity, `pol_reason`, `qod_score`) come from the network's own model.

- **Generated:** 2026-05-23T22:13:51.376Z
- **Public source:** `https://api.weatherxm.com/api/v1/cells`
- **Cells observed:** 8,490
- **Cells over designed capacity (≥1.5× capacity):** 288 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 154
...
2. Of the 154 devices inside the most over-capacity cells, **68** are flagged with `pol_reason: NO_LOCATION_DATA` and **10** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **89** of those devices are inactive yet still counted in the cell, and **93** have `qod_score < 30`.
...
| `871eda743ffffff` | 28 | 3 | 9.3× | 6 | 83 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | null | 39.1691, -77.3527 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 5 | 99 | 30.8796, -88.3141 |
| `873933759ffffff` | 5 | 1 | 5.0× | 3 | 51 | 38.7867, -9.1042 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 98 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 3 | 87 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 8 | 54 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 66 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 24 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 87 | 7.2367, -9.1619 |
...
| `33fe5390-438d-11ef-8e8d-b55568dc8e66` | Y | 25 | — | WS1001/WG1200 | 2026-05-23T17:12:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-05-24T01:12:09+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-05-24T01:03:22+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:10:10-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:10:28-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:12:37-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:10:27-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:11:47-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-04-09T20:23:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:10:37-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T18:12:44-04:00 |
