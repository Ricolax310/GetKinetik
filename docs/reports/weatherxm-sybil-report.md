...
- **Devices observed inside drilled cells:** 188
...
| `NO_LOCATION_DATA` in drilled set | 96 | -2 (-2.0%) |
| Devices with qod < 30 (drilled) | 117 | +4 (+3.5%) |
...
2. Of the 188 devices inside the most over-capacity cells, **96** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **111** of those devices are inactive yet still counted in the cell, and **117** have `qod_score < 30`.
...
| `871eda743ffffff` | 28 | 3 | 9.3× | 7 | 79 | 37.9810, 23.7195 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 52 | 30.8796, -88.3141 |
...
| `871e556e1ffffff` | 8 | 2 | 4.0× | 5 | 66 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 10 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 69 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 3 | 27 | 52.0471, 5.5072 |
...
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 64 | 40.9919, 29.0488 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 97 | — | WS1001/WG1200 | 2026-07-19T17:26:31+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-07-19T17:25:01+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | N | 87 | — | WS2000/WS2000 | 2026-07-19T08:43:14-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | N | 61 | — | WS2000/WS2000 | 2026-07-19T01:11:57-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | N | 87 | — | WS2000/WS2000 | 2026-07-19T08:32:24-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | N | 79 | — | WS2000/WS2000 | 2026-07-19T08:34:42-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 77 | — | WS1001/WG1200 | 2026-07-19T08:43:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | N | 87 | — | WS2000/WS2000 | 2026-07-19T08:42:26-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | N | 87 | — | WS2000/WS2000 | 2026-07-19T08:34:33-04:00 |
