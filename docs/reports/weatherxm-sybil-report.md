...
- **Devices observed inside drilled cells:** 189

## Executive summary

1. **289 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **103 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
...
|---|---:|---|
| Cells on public map | 8,506 | unchanged vs last run |
| Cells ≥1.5× capacity | 289 | unchanged vs last run |
| Share of map over capacity | 3.40% | unchanged vs last run |
| `NO_LOCATION_DATA` in drilled set | 103 | -22 (-17.6%) |
| Devices with qod < 30 (drilled) | 109 | -26 (-19.3%) |
...
2. Of the 189 devices inside the most over-capacity cells, **103** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **112** of those devices are inactive yet still counted in the cell, and **109** have `qod_score < 30`.
...
| `871edcd23ffffff` | 8 | 1 | 8.0× | 6 | 72 | 40.5993, 22.9849 |
| `872aaa945ffffff` | 8 | 1 | 8.0× | 6 | 82 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 100 | 39.2480, -77.2449 |
...
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 22 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | 23 | 7.2367, -9.1619 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-07T17:44:36+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-07T17:22:56+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-08-07T17:44:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-08-07T17:45:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-08-07T17:45:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 99 | — | WS2000/WS2000 | 2026-08-07T17:44:04+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 98 | — | WS1001/WG1200 | 2026-08-07T17:44:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | N | 1 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-08-06T19:51:37+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | Y | 4 | — | WS2000/WS2000 | 2026-08-07T17:43:47+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 76 | — | WS1000/WG1000 | 2026-08-07T17:42:00+03:00 |
