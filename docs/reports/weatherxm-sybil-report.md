...
- **Cells observed:** 8,577
- **Cells over designed capacity (≥1.5× capacity):** 300 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 228

## Executive summary

1. **300 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **134 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **135** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,577 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 300 | unchanged vs last run |
| Share of map over capacity | 3.50% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 134 | +11 (+8.9%) |
| Devices with qod < 30 (drilled) | 135 | +12 (+9.8%) |
...
1. **300 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 228 devices inside the most over-capacity cells, **134** are flagged with `pol_reason: NO_LOCATION_DATA` and **3** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **127** of those devices are inactive yet still counted in the cell, and **135** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 42 | 3 | 14.0× | 8 | 81 | 37.9810, 23.7195 |
...
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 89 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 5 | 90 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 6 | 99 | 40.5993, 22.9849 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | null | 19.2644, -99.0158 |
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 93 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 87 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 0 | null | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 98 | 48.5924, 9.1617 |
| `8726c35a9ffffff` | 5 | 1 | 5.0× | 3 | 78 | 34.8702, -99.5157 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 50 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 7 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 0 | null | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 95 | 40.2933, -75.7373 |
| `8766dc932ffffff` | 4 | 1 | 4.0× | 0 | null | 0.4562, -76.5334 |
| `871969046ffffff` | 4 | 1 | 4.0× | 0 | null | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 81 | 46.3285, 23.7291 |
| `8726c351affffff` | 4 | 1 | 4.0× | 2 | 81 | 34.8788, -99.4895 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 81 | 0.4685, 35.2356 |
...
### 1. Cell `871eda743ffffff` — 42 devices in capacity 3 (14.0×)
...
| `fc192be0-88bc-11ec-900c-abdec1c57354` | N | 0 | NO_LOCATION_DATA | WS1000/WG1000 | 2025-02-21T13:18:35+02:00 |
| `e0108150-a554-11f1-9fa2-d9b3427c596a` | Y | 0 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-09T20:02:33+03:00 |
| `3e5d4520-aaf7-11f1-9fa2-d9b3427c596a` | Y | 0 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-08T10:55:25+03:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-19T19:53:47+03:00 |
| `73adf6d0-a619-11f1-9fa2-d9b3427c596a` | Y | 0 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-09T20:03:36+03:00 |

_…and 30 more devices in this cell._

### 2. Cell `874449b31ffffff` — 10 devices in capacity 1 (10.0×)
...
### 3. Cell `8726cdb66ffffff` — 10 devices in capacity 1 (10.0×)
...
| `250f3ca0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-20T17:17:00-05:00 |
| `2be0b091-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-10-09T03:25:12-05:00 |
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-09-06T13:53:00-05:00 |
...
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-21T01:46:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-09-06T13:53:00-05:00 |
...
### 5. Cell `872aaa945ffffff` — 9 devices in capacity 1 (9.0×)

| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-09-19T12:54:21-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 64 | — | WS2000/WS2000 | 2026-09-19T12:53:16-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-09-19T12:55:31-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-09-19T12:54:33-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 92 | — | WS2000/WS2000 | 2026-09-19T12:53:11-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-19T12:55:27-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-09-19T12:55:23-04:00 |
