...
- **Cells observed:** 8,581
- **Cells over designed capacity (≥1.5× capacity):** 300 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 314

## Executive summary

1. **300 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **179 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **185** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,581 | +3 (+0.0%) |
| Cells ≥1.5× capacity | 300 | unchanged vs last run |
| Share of map over capacity | 3.50% | -0.00 pp (-0.0%) |
| `NO_LOCATION_DATA` in drilled set | 179 | -13 (-6.8%) |
| Devices with qod < 30 (drilled) | 185 | -12 (-6.1%) |
...
2. Of the 314 devices inside the most over-capacity cells, **179** are flagged with `pol_reason: NO_LOCATION_DATA` and **4** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **163** of those devices are inactive yet still counted in the cell, and **185** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 43 | 3 | 14.3× | 11 | 73 | 37.9810, 23.7195 |
...
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 85 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 5 | 100 | 39.2480, -77.2449 |
...
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 98 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 86 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 1 | 65 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 97 | 48.5924, 9.1617 |
| `8726c35a9ffffff` | 5 | 1 | 5.0× | 3 | 72 | 34.8702, -99.5157 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 7 | 84 | 47.1792, 27.5966 |
...
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `877a6ac76ffffff` | 8 | 2 | 4.0× | 8 | 56 | -0.6674, 36.3085 |
| `8766dc932ffffff` | 4 | 1 | 4.0× | 0 | null | 0.4562, -76.5334 |
| `871969046ffffff` | 4 | 1 | 4.0× | 0 | null | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 82 | 46.3285, 23.7291 |
| `8726c351affffff` | 4 | 1 | 4.0× | 2 | 80 | 34.8788, -99.4895 |
...
### 1. Cell `871eda743ffffff` — 43 devices in capacity 3 (14.3×)
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-24T21:03:36+03:00 |
| `73adf6d0-a619-11f1-9fa2-d9b3427c596a` | Y | 0 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-09T20:03:36+03:00 |

_…and 31 more devices in this cell._
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 88 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-09-24T14:03:27-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 33 | — | WS2000/WS2000 | 2026-09-24T14:01:45-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-09-24T14:03:58-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 97 | — | WS2000/WS2000 | 2026-09-24T14:02:51-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 89 | — | WS2000/WS2000 | 2026-09-24T14:04:36-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 98 | — | WS2000/WS2000 | 2026-09-24T14:01:54-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 98 | — | WS2000/WS2000 | 2026-09-24T14:04:07-04:00 |
