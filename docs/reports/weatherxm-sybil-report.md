...
|---|---:|---|
| Cells on public map | 8,507 | +4 (+0.0%) |
| Cells ≥1.5× capacity | 291 | unchanged vs last run |
| Share of map over capacity | 3.42% | -0.00 pp (-0.0%) |
| `NO_LOCATION_DATA` in drilled set | 96 | -13 (-11.9%) |
| Devices with qod < 30 (drilled) | 101 | -11 (-9.8%) |
...
2. Of the 184 devices inside the most over-capacity cells, **96** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **106** of those devices are inactive yet still counted in the cell, and **101** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 1 | null | 33.8746, -94.8049 |
...
| `871edcd23ffffff` | 7 | 1 | 7.0× | 7 | 72 | 40.5993, 22.9849 |
...
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 89 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 53 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 8 | 84 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 1 | 18 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | 11 | 7.2367, -9.1619 |
...
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 77 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 48 | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 62 | 40.9919, 29.0488 |
| `8728f00c0ffffff` | 7 | 2 | 3.5× | 3 | 42 | 45.6894, -122.6790 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-14T00:39:00-05:00 |
...
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-06-26T15:40:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-14T17:42:34+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-14T17:43:15+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | — | WS2000/WS2000 | 2026-08-14T10:42:12-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 66 | — | WS2000/WS2000 | 2026-08-14T10:43:03-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-14T10:43:46-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 93 | — | WS2000/WS2000 | 2026-08-14T10:41:47-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-14T10:43:59-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-08-14T10:42:18-04:00 |
