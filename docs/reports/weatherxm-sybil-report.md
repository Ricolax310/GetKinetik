...
| `NO_LOCATION_DATA` in drilled set | 129 | +2 (+1.6%) |
| Devices with qod < 30 (drilled) | 130 | +6 (+4.8%) |
...
2. Of the 216 devices inside the most over-capacity cells, **129** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **121** of those devices are inactive yet still counted in the cell, and **130** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 34 | 3 | 11.3× | 9 | 88 | 37.9810, 23.7195 |
...
| `871edcd23ffffff` | 8 | 1 | 8.0× | 6 | 92 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 88 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | null | 19.2644, -99.0158 |
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 94 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 91 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 5 | 59 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 100 | 48.5924, 9.1617 |
| `8726c35a9ffffff` | 5 | 1 | 5.0× | 3 | 95 | 34.8702, -99.5157 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 55 | -0.6674, 36.3085 |
...
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 85 | 46.3285, 23.7291 |
...
### 1. Cell `871eda743ffffff` — 34 devices in capacity 3 (11.3×)
...
| `e0108150-a554-11f1-9fa2-d9b3427c596a` | Y | 0 | NO_LOCATION_DATA | WS1001/WG3000 | 2026-09-01T20:30:11+03:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-01T20:28:42+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `df04b930-bd65-11ef-9198-cde0089ff1ff` | N | 0 | NO_LOCATION_DATA | WS1000/WG1000 | 2025-02-21T12:41:21+02:00 |

_…and 22 more devices in this cell._
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-26T13:14:00-05:00 |
...
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-28T11:18:00-05:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | — | WS2000/WS2000 | 2026-09-01T13:29:44-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 64 | — | WS2000/WS2000 | 2026-09-01T13:28:17-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-09-01T13:27:56-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-09-01T13:30:07-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 92 | — | WS2000/WS2000 | 2026-09-01T13:28:44-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-01T13:26:20-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 99 | — | WS2000/WS2000 | 2026-09-01T13:27:51-04:00 |
