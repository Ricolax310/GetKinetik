...
3. **98** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,505 | -2 (-0.0%) |
| Cells ≥1.5× capacity | 292 | unchanged vs last run |
| Share of map over capacity | 3.43% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 99 | -9 (-8.3%) |
| Devices with qod < 30 (drilled) | 98 | -9 (-8.4%) |
...
2. Of the 196 devices inside the most over-capacity cells, **99** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **108** of those devices are inactive yet still counted in the cell, and **98** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 0 | 41 | 33.8746, -94.8049 |
| `871eda743ffffff` | 29 | 3 | 9.7× | 8 | 84 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 97 | 40.5993, 22.9849 |
| `872aaa945ffffff` | 8 | 1 | 8.0× | 6 | 92 | 39.1691, -77.3527 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 66 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 100 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 3 | 63 | 34.8788, -99.4895 |
...
| `874995809ffffff` | 4 | 1 | 4.0× | 0 | 8 | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 2 | 82 | 40.9919, 29.0488 |
| `8728f00c0ffffff` | 7 | 2 | 3.5× | 3 | 41 | 45.6894, -122.6790 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 41 | — | WS1001/WG1200 | 2026-08-24T15:05:00-05:00 |
...
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 41 | — | WS1001/WG1200 | 2026-08-24T15:02:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-25T17:34:34+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-25T17:11:55+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 99 | — | WS1000/WG1000 | 2026-08-25T17:33:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-08-25T17:34:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-08-25T17:34:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-25T17:33:17+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 96 | — | WS1001/WG1200 | 2026-08-25T17:34:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-08-18T21:12:08+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-25T17:34:20+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 89 | — | WS1000/WG1000 | 2026-08-25T17:33:00+03:00 |
