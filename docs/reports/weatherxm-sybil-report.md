...
- **Cells observed:** 8,495
- **Cells over designed capacity (≥1.5× capacity):** 287 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 275

## Executive summary

1. **287 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **105 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
...
|---|---:|---|
| Cells on public map | 8,495 | +1 (+0.0%) |
| Cells ≥1.5× capacity | 287 | unchanged vs last run |
| Share of map over capacity | 3.38% | -0.00 pp (-0.0%) |
| `NO_LOCATION_DATA` in drilled set | 105 | +13 (+14.1%) |
| Devices with qod < 30 (drilled) | 128 | +14 (+12.3%) |
...
1. **287 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 275 devices inside the most over-capacity cells, **105** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **129** of those devices are inactive yet still counted in the cell, and **128** have `qod_score < 30`.
...
| `872aaa945ffffff` | 10 | 1 | 10.0× | 9 | 91 | 39.1691, -77.3527 |
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 0 | 26 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 9 | 70 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 99 | 40.5993, 22.9849 |
| `873933759ffffff` | 8 | 1 | 8.0× | 7 | 78 | 38.7867, -9.1042 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 91 | 39.2480, -77.2449 |
...
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 42 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 1 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 30 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 95 | 40.2933, -75.7373 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 87 | 46.3285, 23.7291 |
| `8726c351affffff` | 4 | 1 | 4.0× | 3 | 74 | 34.8788, -99.4895 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 76 | 0.4685, 35.2356 |
| `8726c35a9ffffff` | 4 | 1 | 4.0× | 3 | 98 | 34.8702, -99.5157 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 24 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 5 | 62 | 37.9821, 23.6894 |
...
|---|---:|
| `NO_LOCATION_DATA` | 105 |
| `QOD_THRESHOLD_NOT_REACHED` | 1 |
...
### 2. Cell `872aaa945ffffff` — 10 devices in capacity 1 (10.0×)

| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-06-27T10:28:52-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | N | 66 | — | WS2000/WS2000 | 2026-06-27T01:24:28-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-06-27T10:29:04-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-06-27T10:30:32-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 79 | — | WS2000/WS2000 | 2026-06-27T10:29:02-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 75 | — | WS1001/WG1200 | 2026-06-27T10:30:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-06-27T10:28:25-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `50fe7e80-bf53-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-06-27T10:28:40-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-06-27T10:28:27-04:00 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 13 | — | WS1001/WG1200 | 2026-06-25T22:21:00-05:00 |
...
| `2e198990-438d-11ef-8e8d-b55568dc8e66` | N | 36 | — | WS1001/WG1200 | 2026-06-26T03:50:00-05:00 |
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-06-25T12:20:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 29 | — | WS1001/WG1200 | 2026-06-26T15:40:00-05:00 |

### 4. Cell `871eda743ffffff` — 28 devices in capacity 3 (9.3×)
...
| `fe601050-963e-11ec-900c-abdec1c57354` | Y | 71 | — | WS1000/WG1000 | 2026-06-27T17:29:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-06-27T17:30:11+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | Y | 71 | — | WS1000/WG1000 | 2026-06-27T17:29:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 99 | — | WS1001/WG3000 | 2026-06-27T17:22:39+03:00 |

_…and 16 more devices in this cell._

### 5. Cell `872b0e115ffffff` — 9 devices in capacity 1 (9.0×)
