...
- **Cells observed:** 8,496
- **Cells over designed capacity (≥1.5× capacity):** 285 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 219

## Executive summary

1. **285 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **100 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **117** drilled devices sit below qod 30 while still counted toward cell saturation.
...
| Cells ≥1.5× capacity | 285 | -1 (-0.3%) |
| Share of map over capacity | 3.35% | -0.01 pp (-0.4%) |
| `NO_LOCATION_DATA` in drilled set | 100 | -5 (-4.8%) |
| Devices with qod < 30 (drilled) | 117 | -7 (-5.6%) |
...
1. **285 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 219 devices inside the most over-capacity cells, **100** are flagged with `pol_reason: NO_LOCATION_DATA` and **8** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **114** of those devices are inactive yet still counted in the cell, and **117** have `qod_score < 30`.
...
| `871eda743ffffff` | 29 | 3 | 9.7× | 10 | 83 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 8 | 74 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 99 | 40.5993, 22.9849 |
| `873933759ffffff` | 8 | 1 | 8.0× | 6 | 67 | 38.7867, -9.1042 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 100 | 39.2480, -77.2449 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 55 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 99 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 2 | 76 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 34 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 85 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 1 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 26 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | 3 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 3 | 74 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 98 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 66 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 25 | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 57 | 40.9919, 29.0488 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-06-10T23:34:00-05:00 |
...
| `2e198990-438d-11ef-8e8d-b55568dc8e66` | N | 0 | QOD_THRESHOLD_NOT_REACHED | WS1001/WG1200 | 2026-06-22T01:53:00-05:00 |
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-06-16T20:31:00-05:00 |
...
| `fe601050-963e-11ec-900c-abdec1c57354` | Y | 71 | — | WS1000/WG1000 | 2026-06-24T17:54:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-06-24T17:54:57+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | Y | 68 | — | WS1000/WG1000 | 2026-06-24T17:54:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 99 | — | WS1001/WG3000 | 2026-06-24T17:33:55+03:00 |

_…and 17 more devices in this cell._
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 82 | — | WS2000/WS2000 | 2026-06-24T10:54:51-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 33 | — | WS2000/WS2000 | 2026-06-24T10:53:43-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 81 | — | WS2000/WS2000 | 2026-06-24T10:55:07-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 82 | — | WS2000/WS2000 | 2026-06-24T10:54:30-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 74 | — | WS2000/WS2000 | 2026-06-24T10:55:06-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 76 | — | WS1001/WG1200 | 2026-06-24T10:55:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 82 | — | WS2000/WS2000 | 2026-06-24T10:54:24-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 82 | — | WS2000/WS2000 | 2026-06-24T10:54:47-04:00 |
