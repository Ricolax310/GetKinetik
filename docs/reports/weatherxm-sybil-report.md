...
- **Devices observed inside drilled cells:** 200

## Executive summary

1. **289 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **115 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **124** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,492 | -6 (-0.1%) |
| Cells ≥1.5× capacity | 289 | unchanged vs last run |
| Share of map over capacity | 3.40% | +0.00 pp (+0.1%) |
| `NO_LOCATION_DATA` in drilled set | 115 | +19 (+19.8%) |
| Devices with qod < 30 (drilled) | 124 | +7 (+6.0%) |
...
2. Of the 200 devices inside the most over-capacity cells, **115** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **108** of those devices are inactive yet still counted in the cell, and **124** have `qod_score < 30`.
...
| `872aaa945ffffff` | 8 | 1 | 8.0× | 7 | 80 | 39.1691, -77.3527 |
...
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 89 | 47.7470, 16.2250 |
...
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 76 | 47.1792, 27.5966 |
...
| `871969046ffffff` | 4 | 1 | 4.0× | 2 | 61 | 52.0471, 5.5072 |
...
| `871eda742ffffff` | 7 | 2 | 3.5× | 6 | 79 | 37.9821, 23.6894 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 63 | 40.9919, 29.0488 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 98 | — | WS1001/WG1200 | 2026-07-20T17:42:10+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-07-20T17:22:59+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 87 | — | WS2000/WS2000 | 2026-07-20T10:42:44-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 56 | — | WS2000/WS2000 | 2026-07-20T10:43:21-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 86 | — | WS2000/WS2000 | 2026-07-20T10:42:37-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 80 | — | WS2000/WS2000 | 2026-07-20T10:40:50-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 79 | — | WS1001/WG1200 | 2026-07-20T10:43:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 86 | — | WS2000/WS2000 | 2026-07-20T10:40:41-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 86 | — | WS2000/WS2000 | 2026-07-20T10:41:51-04:00 |
