...
- **Cells observed:** 8,564
- **Cells over designed capacity (≥1.5× capacity):** 298 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 326

## Executive summary

1. **298 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **191 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **196** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,564 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 298 | unchanged vs last run |
| Share of map over capacity | 3.48% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 191 | +40 (+26.5%) |
| Devices with qod < 30 (drilled) | 196 | +42 (+27.3%) |
...
2. Of the 326 devices inside the most over-capacity cells, **191** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **181** of those devices are inactive yet still counted in the cell, and **196** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 37 | 3 | 12.3× | 8 | 84 | 37.9810, 23.7195 |
...
| `872aaa945ffffff` | 8 | 1 | 8.0× | 6 | 90 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 90 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 5 | 99 | 40.5993, 22.9849 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 1 | null | 19.2644, -99.0158 |
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 90 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 88 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 60 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 96 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 3 | 75 | 34.8788, -99.4895 |
...
### 1. Cell `871eda743ffffff` — 37 devices in capacity 3 (12.3×)
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-07T21:28:11+03:00 |
...
_…and 25 more devices in this cell._
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | — | WS2000/WS2000 | 2026-09-07T14:30:05-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 66 | — | WS2000/WS2000 | 2026-09-07T14:30:16-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-09-07T14:29:44-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 91 | — | WS2000/WS2000 | 2026-09-07T14:28:23-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-07T14:29:10-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-09-07T14:27:33-04:00 |
