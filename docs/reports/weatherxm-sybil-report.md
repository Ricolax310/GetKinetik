...
- **Devices observed inside drilled cells:** 101
...
2. Of the 101 devices inside the most over-capacity cells, **55** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **65** of those devices are inactive yet still counted in the cell, and **68** have `qod_score < 30`.
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-05-23T20:29:10+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-05-23T20:14:23+03:00 |
