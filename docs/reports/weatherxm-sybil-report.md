...
- **Cells over designed capacity (≥1.5× capacity):** 298 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 324
...
3. **190** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,576 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 298 | unchanged vs last run |
| Share of map over capacity | 3.47% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 188 | -3 (-1.6%) |
| Devices with qod < 30 (drilled) | 190 | -4 (-2.1%) |
...
1. **298 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 324 devices inside the most over-capacity cells, **188** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **171** of those devices are inactive yet still counted in the cell, and **190** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 41 | 3 | 13.7× | 8 | 70 | 37.9810, 23.7195 |
...
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 88 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 96 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 5 | 87 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | null | 19.2644, -99.0158 |
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 82 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 85 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 0 | 30 | 30.8796, -88.3141 |
...
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 79 | 46.3285, 23.7291 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-15T20:48:15+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 84 | — | WS2000/WS2000 | 2026-09-15T13:49:25-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 63 | — | WS2000/WS2000 | 2026-09-15T13:49:26-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 83 | — | WS2000/WS2000 | 2026-09-15T13:49:26-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 99 | — | WS2000/WS2000 | 2026-09-15T13:49:25-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 95 | — | WS2000/WS2000 | 2026-09-15T13:49:26-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 99 | — | WS2000/WS2000 | 2026-09-15T13:50:05-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 98 | — | WS2000/WS2000 | 2026-09-15T13:49:26-04:00 |
