...
|---|---:|---|
| Cells on public map | 8,497 | unchanged vs last run |
| Cells ≥1.5× capacity | 288 | unchanged vs last run |
| Share of map over capacity | 3.39% | unchanged vs last run |
| `NO_LOCATION_DATA` in drilled set | 99 | +13 (+15.1%) |
| Devices with qod < 30 (drilled) | 119 | +24 (+25.3%) |
...
2. Of the 209 devices inside the most over-capacity cells, **99** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **118** of those devices are inactive yet still counted in the cell, and **119** have `qod_score < 30`.
...
| `872aaa945ffffff` | 9 | 1 | 9.0× | 8 | 91 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 100 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 7 | 75 | 40.5993, 22.9849 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 54 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 4 | 80 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 91 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 56 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 64 | 47.1792, 27.5966 |
...
| `871969046ffffff` | 4 | 1 | 4.0× | 3 | 51 | 52.0471, 5.5072 |
...
| `871eda742ffffff` | 7 | 2 | 3.5× | 4 | 64 | 37.9821, 23.6894 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 61 | 40.9919, 29.0488 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 98 | — | WS1001/WG1200 | 2026-07-17T17:29:35+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 98 | — | WS1001/WG3000 | 2026-07-17T17:25:04+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-17T10:31:10-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 68 | — | WS2000/WS2000 | 2026-07-17T10:29:40-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-07-17T10:28:31-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-17T10:29:24-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 91 | — | WS2000/WS2000 | 2026-07-17T10:30:37-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 76 | — | WS1001/WG1200 | 2026-07-17T10:31:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-07-17T10:30:25-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-07-17T10:28:37-04:00 |
