...
2. **157 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
...
|---|---:|---|
| Cells on public map | 8,511 | -4 (-0.0%) |
| Cells ≥1.5× capacity | 292 | +1 (+0.3%) |
| Share of map over capacity | 3.43% | +0.01 pp (+0.4%) |
| `NO_LOCATION_DATA` in drilled set | 157 | +23 (+17.2%) |
...
2. Of the 297 devices inside the most over-capacity cells, **157** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **144** of those devices are inactive yet still counted in the cell, and **153** have `qod_score < 30`.
...
| `874450316ffffff` | 5 | 1 | 5.0× | 5 | 67 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 99 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 3 | 83 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 58 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 7 | 86 | 47.1792, 27.5966 |
...
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 86 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 80 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 15 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 5 | 72 | 37.9821, 23.6894 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 2 | 76 | 40.9919, 29.0488 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-31T22:43:13+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-31T22:18:14+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-08-31T15:43:38-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 62 | — | WS2000/WS2000 | 2026-08-31T15:43:23-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-08-31T15:43:53-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-31T15:42:43-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 91 | — | WS2000/WS2000 | 2026-08-31T15:44:22-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-31T15:44:58-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-08-31T15:43:28-04:00 |
