...
- **Cells observed:** 8,506
- **Cells over designed capacity (≥1.5× capacity):** 292 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 267

## Executive summary

1. **292 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **114 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **119** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,506 | -2 (-0.0%) |
| Cells ≥1.5× capacity | 292 | +1 (+0.3%) |
| Share of map over capacity | 3.43% | +0.01 pp (+0.4%) |
| `NO_LOCATION_DATA` in drilled set | 114 | -7 (-5.8%) |
| Devices with qod < 30 (drilled) | 119 | -9 (-7.0%) |
...
2. Of the 267 devices inside the most over-capacity cells, **114** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **128** of those devices are inactive yet still counted in the cell, and **119** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 2 | 23 | 33.8746, -94.8049 |
| `871eda743ffffff` | 29 | 3 | 9.7× | 8 | 86 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 8 | 1 | 8.0× | 6 | 65 | 39.1691, -77.3527 |
...
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 93 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 62 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 97 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 63 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 55 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 7 | 74 | 47.1792, 27.5966 |
...
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 48 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 36 | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 2 | 82 | 40.9919, 29.0488 |
| `8728f00c0ffffff` | 7 | 2 | 3.5× | 3 | 43 | 45.6894, -122.6790 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 21 | — | WS1001/WG1200 | 2026-08-22T23:02:00-05:00 |
...
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 28 | — | WS1001/WG1200 | 2026-08-21T01:46:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 21 | — | WS1001/WG1200 | 2026-08-22T23:02:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-23T17:13:07+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 66 | — | WS1001/WG3000 | 2026-08-23T17:01:28+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 59 | — | WS2000/WS2000 | 2026-08-23T10:14:30-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 65 | — | WS2000/WS2000 | 2026-08-23T10:13:32-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 69 | — | WS2000/WS2000 | 2026-08-23T10:13:20-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 63 | — | WS2000/WS2000 | 2026-08-23T10:11:56-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 69 | — | WS2000/WS2000 | 2026-08-23T10:13:34-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 69 | — | WS2000/WS2000 | 2026-08-23T10:12:27-04:00 |
