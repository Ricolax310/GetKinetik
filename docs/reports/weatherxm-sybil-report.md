...
|---|---:|---|
| Cells on public map | 8,500 | -4 (-0.0%) |
| Cells ≥1.5× capacity | 288 | unchanged vs last run |
| Share of map over capacity | 3.39% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 105 | +11 (+11.7%) |
| Devices with qod < 30 (drilled) | 118 | +15 (+14.6%) |
...
2. Of the 199 devices inside the most over-capacity cells, **105** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **110** of those devices are inactive yet still counted in the cell, and **118** have `qod_score < 30`.
...
| `871eda743ffffff` | 28 | 3 | 9.3× | 7 | 74 | 37.9810, 23.7195 |
...
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 19 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 54 | 7.2367, -9.1619 |
...
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 51 | 40.9919, 29.0488 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-07-26T17:27:38+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 52 | — | WS1001/WG3000 | 2026-07-26T17:20:18+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-07-26T17:28:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-26T17:29:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-26T17:29:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-26T17:27:57+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 80 | — | WS1001/WG1200 | 2026-07-26T17:29:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | N | 1 | — | WS2000/WS2000 | 2026-07-26T16:34:30+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | N | 3 | — | WS2000/WS2000 | 2026-07-26T11:45:36+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 99 | — | WS1000/WG1000 | 2026-07-26T17:29:00+03:00 |
