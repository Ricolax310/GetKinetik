...
- **Devices observed inside drilled cells:** 202
...
|---|---:|---|
| Cells on public map | 8,496 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 289 | -1 (-0.3%) |
| Share of map over capacity | 3.40% | -0.01 pp (-0.3%) |
| `NO_LOCATION_DATA` in drilled set | 109 | -6 (-5.2%) |
| Devices with qod < 30 (drilled) | 119 | -2 (-1.7%) |
...
2. Of the 202 devices inside the most over-capacity cells, **109** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **109** of those devices are inactive yet still counted in the cell, and **119** have `qod_score < 30`.
...
| `872aaa945ffffff` | 8 | 1 | 8.0× | 7 | 89 | 39.1691, -77.3527 |
...
| `871faa694ffffff` | 5 | 1 | 5.0× | 4 | 97 | 48.5924, 9.1617 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 74 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 1 | 9 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 67 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `877a6ac76ffffff` | 8 | 2 | 4.0× | 8 | 59 | -0.6674, 36.3085 |
| `871969046ffffff` | 4 | 1 | 4.0× | 0 | 19 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 84 | 46.3285, 23.7291 |
| `8726c351affffff` | 4 | 1 | 4.0× | 3 | 80 | 34.8788, -99.4895 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-07-24T17:31:02+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-07-24T17:26:51+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-07-24T17:32:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-24T17:33:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-24T17:33:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-24T17:33:14+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | N | 98 | — | WS1001/WG1200 | 2026-07-24T17:21:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | N | 1 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-07-24T15:10:19+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | Y | 2 | — | WS2000/WS2000 | 2026-07-24T17:30:41+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 80 | — | WS1000/WG1000 | 2026-07-24T17:32:00+03:00 |
