...
- **Cells observed:** 8,492
- **Cells over designed capacity (≥1.5× capacity):** 288 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 103

## Executive summary

1. **288 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **52 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **61** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,492 | +3 (+0.0%) |
| Cells ≥1.5× capacity | 288 | -1 (-0.3%) |
| Share of map over capacity | 3.39% | -0.01 pp (-0.4%) |
| `NO_LOCATION_DATA` in drilled set | 52 | -15 (-22.4%) |
| Devices with qod < 30 (drilled) | 61 | -10 (-14.1%) |
...
2. Of the 103 devices inside the most over-capacity cells, **52** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **60** of those devices are inactive yet still counted in the cell, and **61** have `qod_score < 30`.
...
| `871eda743ffffff` | 28 | 3 | 9.3× | 10 | 86 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 92 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 85 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 93 | 39.2480, -77.2449 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 93 | 30.8796, -88.3141 |
| `873933759ffffff` | 5 | 1 | 5.0× | 3 | 73 | 38.7867, -9.1042 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 94 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 87 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 48 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 61 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 23 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 91 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 4 | 90 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 4 | 87 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 73 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 0 | 6 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 6 | 67 | 37.9821, 23.6894 |
...
| `33fe5390-438d-11ef-8e8d-b55568dc8e66` | N | 0 | QOD_THRESHOLD_NOT_REACHED | WS1001/WG1200 | 2026-05-29T11:41:00-05:00 |
...
| `fe601050-963e-11ec-900c-abdec1c57354` | Y | 64 | — | WS1000/WG1000 | 2026-06-01T19:05:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 100 | — | WS1001/WG1200 | 2026-06-01T19:05:11+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | Y | 65 | — | WS1000/WG1000 | 2026-06-01T19:05:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 93 | — | WS1001/WG3000 | 2026-06-01T19:00:37+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 94 | — | WS2000/WS2000 | 2026-06-01T12:04:30-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 94 | — | WS2000/WS2000 | 2026-06-01T12:05:13-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 94 | — | WS2000/WS2000 | 2026-06-01T12:04:15-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 94 | — | WS2000/WS2000 | 2026-06-01T12:04:58-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 83 | — | WS2000/WS2000 | 2026-06-01T12:06:27-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-04-09T20:23:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 93 | — | WS2000/WS2000 | 2026-06-01T12:05:09-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 94 | — | WS2000/WS2000 | 2026-06-01T12:04:23-04:00 |
