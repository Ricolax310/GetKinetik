...
- **Cells observed:** 8,576
- **Cells over designed capacity (≥1.5× capacity):** 300 (3.5%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 313

## Executive summary

1. **300 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **176 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **179** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,576 | -4 (-0.0%) |
| Cells ≥1.5× capacity | 300 | +1 (+0.3%) |
| Share of map over capacity | 3.50% | +0.01 pp (+0.4%) |
| `NO_LOCATION_DATA` in drilled set | 176 | +27 (+18.1%) |
| Devices with qod < 30 (drilled) | 179 | +28 (+18.5%) |
...
2. Of the 313 devices inside the most over-capacity cells, **176** are flagged with `pol_reason: NO_LOCATION_DATA` and **4** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **159** of those devices are inactive yet still counted in the cell, and **179** have `qod_score < 30`.
...
|---|---:|---:|---:|---:|---:|---|
| `871eda743ffffff` | 42 | 3 | 14.0× | 11 | 71 | 37.9810, 23.7195 |
...
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 93 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 4 | 89 | 39.2480, -77.2449 |
...
| `873933759ffffff` | 6 | 1 | 6.0× | 1 | 96 | 38.7867, -9.1042 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 87 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 1 | null | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 97 | 48.5924, 9.1617 |
| `8726c35a9ffffff` | 5 | 1 | 5.0× | 3 | 76 | 34.8702, -99.5157 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 56 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 7 | 81 | 47.1792, 27.5966 |
...
| `8726c351affffff` | 4 | 1 | 4.0× | 2 | 79 | 34.8788, -99.4895 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 80 | 0.4685, 35.2356 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-09-22T20:48:21+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 98 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-09-22T13:50:06-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | N | 63 | — | WS2000/WS2000 | 2026-09-21T23:22:32-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-22T13:48:04-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-09-22T13:47:19-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 91 | — | WS2000/WS2000 | 2026-09-22T13:48:43-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-09-22T13:49:20-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-09-22T13:47:54-04:00 |
