...
- **Generated:** 2026-05-13T20:52:20.479Z
- **Public source:** `https://api.weatherxm.com/api/v1/cells`
- **Cells observed:** 8,487
- **Cells over designed capacity (≥1.5× capacity):** 290 (3.4%)
- **Cells drilled in this report:** 40 (top by capacity ratio)
- **Devices observed inside drilled cells:** 112
...
2. Of the 112 devices inside the most over-capacity cells, **60** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **69** of those devices are inactive yet still counted in the cell, and **73** have `qod_score < 30`.
...
| `871eda743ffffff` | 29 | 3 | 9.7× | 11 | 97 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 96 | 40.5993, 22.9849 |
| `872aaa945ffffff` | 8 | 1 | 8.0× | 6 | 94 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 90 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 1 | 99 | 19.2644, -99.0158 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 94 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 100 | 30.8796, -88.3141 |
| `873933759ffffff` | 5 | 1 | 5.0× | 4 | 73 | 38.7867, -9.1042 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 100 | 48.5924, 9.1617 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 57 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 5 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 60 | 42.6764, -84.5014 |
...
| `871969046ffffff` | 4 | 1 | 4.0× | 4 | 37 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 92 | 46.3285, 23.7291 |
| `8726c351affffff` | 4 | 1 | 4.0× | 1 | 65 | 34.8788, -99.4895 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 59 | 0.4685, 35.2356 |
| `8726c35a9ffffff` | 4 | 1 | 4.0× | 3 | 100 | 34.8702, -99.5157 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 28 | 19.2595, -99.0815 |

_…and 15 more drilled cells in the snapshot file._
...
| `33fe5390-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-09-03T23:26:02-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-05-13T23:50:11+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | Y | 99 | — | WS1001/WG1200 | 2026-05-13T23:50:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | N | 0 | NO_LOCATION_DATA | WS1000/WG1000 | 2025-12-28T10:45:00+02:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-05-13T23:22:41+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-05-13T23:50:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 94 | — | WS1001/WG1200 | 2026-05-13T23:51:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-05-13T23:51:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-05-13T23:51:08+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-05-13T23:51:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-05-13T23:51:29+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-05-13T23:51:27+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 78 | — | WS1000/WG1000 | 2026-05-13T23:49:00+03:00 |
...
- The drilled set is intentionally small (top 40 cells) so every row in section 4 is auditable by hand.
