...
3. **139** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,503 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 289 | +1 (+0.3%) |
| Share of map over capacity | 3.40% | +0.01 pp (+0.4%) |
| `NO_LOCATION_DATA` in drilled set | 129 | +12 (+10.3%) |
| Devices with qod < 30 (drilled) | 139 | +18 (+14.9%) |
...
2. Of the 250 devices inside the most over-capacity cells, **129** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **138** of those devices are inactive yet still counted in the cell, and **139** have `qod_score < 30`.
...
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 89 | 39.2480, -77.2449 |
...
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 90 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 56 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 4 | 79 | 48.5924, 9.1617 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 56 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 68 | 47.1792, 27.5966 |
...
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 97 | 40.2933, -75.7373 |
...
| `871eda742ffffff` | 7 | 2 | 3.5× | 4 | 80 | 37.9821, 23.6894 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-08T17:22:35+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-08T17:21:24+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 97 | — | WS2000/WS2000 | 2026-08-08T10:22:37-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 63 | — | WS2000/WS2000 | 2026-08-08T10:20:35-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-08-08T10:22:11-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 97 | — | WS2000/WS2000 | 2026-08-08T10:22:30-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 88 | — | WS2000/WS2000 | 2026-08-08T10:22:00-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-08-08T10:22:36-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 97 | — | WS2000/WS2000 | 2026-08-08T10:21:52-04:00 |
