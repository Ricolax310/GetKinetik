...
- **Devices observed inside drilled cells:** 262
...
3. **140** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,509 | -3 (-0.0%) |
| Cells ≥1.5× capacity | 288 | +3 (+1.1%) |
| Share of map over capacity | 3.38% | +0.04 pp (+1.1%) |
| `NO_LOCATION_DATA` in drilled set | 129 | +36 (+38.7%) |
| Devices with qod < 30 (drilled) | 140 | +36 (+34.6%) |
...
2. Of the 262 devices inside the most over-capacity cells, **129** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **134** of those devices are inactive yet still counted in the cell, and **140** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 2 | 29 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 7 | 91 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 90 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 65 | 40.5993, 22.9849 |
...
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 46 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 8 | 86 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 13 | 19.2735, -99.1014 |
...
| `8726c351affffff` | 4 | 1 | 4.0× | 3 | 60 | 34.8788, -99.4895 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 30 | 0.4685, 35.2356 |
| `8726c35a9ffffff` | 4 | 1 | 4.0× | 3 | 96 | 34.8702, -99.5157 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 28 | 19.2595, -99.0815 |
...
| `250f3ca0-438d-11ef-8e8d-b55568dc8e66` | N | 16 | — | WS1001/WG1200 | 2026-08-18T01:37:00-05:00 |
| `2be0b091-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-10-09T03:25:12-05:00 |
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 41 | — | WS1001/WG1200 | 2026-08-18T23:34:00-05:00 |
...
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 20 | — | WS1001/WG1200 | 2026-08-18T03:38:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 41 | — | WS1001/WG1200 | 2026-08-18T23:34:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-19T17:22:14+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-19T17:18:36+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-08-19T10:21:50-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 62 | — | WS2000/WS2000 | 2026-08-19T10:23:20-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-08-19T10:23:03-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-08-19T10:20:55-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 84 | — | WS2000/WS2000 | 2026-08-19T10:22:30-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 98 | — | WS2000/WS2000 | 2026-08-19T10:21:00-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 98 | — | WS2000/WS2000 | 2026-08-19T10:23:03-04:00 |
