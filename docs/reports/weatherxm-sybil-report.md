...
- **Cells over designed capacity (≥1.5× capacity):** 286 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 282
...
| Share of map over capacity | 3.37% | -0.02 pp (-0.7%) |
| `NO_LOCATION_DATA` in drilled set | 104 | +18 (+20.9%) |
| Devices with qod < 30 (drilled) | 129 | +23 (+21.7%) |
...
1. **286 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 282 devices inside the most over-capacity cells, **104** are flagged with `pol_reason: NO_LOCATION_DATA` and **9** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **133** of those devices are inactive yet still counted in the cell, and **129** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 0 | 28 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 10 | 89 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 8 | 86 | 39.1691, -77.3527 |
| `873933759ffffff` | 8 | 1 | 8.0× | 6 | 69 | 38.7867, -9.1042 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 98 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 7 | 99 | 40.5993, 22.9849 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | 14 | 19.2644, -99.0158 |
...
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 33 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 82 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 1 | 59 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 28 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 4 | 70 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 97 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 66 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 31 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 5 | 78 | 37.9821, 23.6894 |
...
| `2e198990-438d-11ef-8e8d-b55568dc8e66` | N | 28 | — | WS1001/WG1200 | 2026-06-22T01:53:00-05:00 |
...
| `fe601050-963e-11ec-900c-abdec1c57354` | Y | 67 | — | WS1000/WG1000 | 2026-06-24T00:44:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 98 | — | WS1001/WG1200 | 2026-06-24T00:44:58+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | Y | 71 | — | WS1000/WG1000 | 2026-06-24T00:44:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-06-24T00:36:27+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 95 | — | WS2000/WS2000 | 2026-06-23T17:45:35-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 61 | — | WS2000/WS2000 | 2026-06-23T17:43:17-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 96 | — | WS2000/WS2000 | 2026-06-23T17:45:46-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 95 | — | WS2000/WS2000 | 2026-06-23T17:44:15-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 84 | — | WS2000/WS2000 | 2026-06-23T17:45:44-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 70 | — | WS1001/WG1200 | 2026-06-23T17:45:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 95 | — | WS2000/WS2000 | 2026-06-23T17:45:57-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 95 | — | WS2000/WS2000 | 2026-06-23T17:45:09-04:00 |
