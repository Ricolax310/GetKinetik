...
- **Devices observed inside drilled cells:** 194

## Executive summary

1. **289 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **98 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **111** drilled devices sit below qod 30 while still counted toward cell saturation.
...
| `NO_LOCATION_DATA` in drilled set | 98 | -11 (-10.1%) |
| Devices with qod < 30 (drilled) | 111 | -19 (-14.6%) |
...
2. Of the 194 devices inside the most over-capacity cells, **98** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **116** of those devices are inactive yet still counted in the cell, and **111** have `qod_score < 30`.
...
| `871eda743ffffff` | 27 | 3 | 9.0× | 6 | 78 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 8 | 1 | 8.0× | 7 | 91 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 100 | 39.2480, -77.2449 |
| `871edcd23ffffff` | 7 | 1 | 7.0× | 7 | 73 | 40.5993, 22.9849 |
...
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 85 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 87 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 8 | 56 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 6 | 66 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | 1 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 13 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | 12 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 3 | 48 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 79 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 78 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 3 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 6 | 64 | 37.9821, 23.6894 |
...
### 3. Cell `871eda743ffffff` — 27 devices in capacity 3 (9.0×)
...
| `fe601050-963e-11ec-900c-abdec1c57354` | N | 34 | — | WS1000/WG1000 | 2026-07-08T15:28:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 98 | — | WS1001/WG1200 | 2026-07-11T17:23:05+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | N | 38 | — | WS1000/WG1000 | 2026-07-08T15:28:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 96 | — | WS1001/WG3000 | 2026-07-11T17:08:15+03:00 |

_…and 15 more devices in this cell._
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-11T10:25:32-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 63 | — | WS2000/WS2000 | 2026-07-11T10:25:18-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-11T10:24:08-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 87 | — | WS2000/WS2000 | 2026-07-11T10:25:19-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | Y | 89 | — | WS1001/WG1200 | 2026-07-11T10:25:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-07-11T10:25:19-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-07-11T10:26:20-04:00 |
