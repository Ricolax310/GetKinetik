...
- **Devices observed inside drilled cells:** 255

## Executive summary

1. **291 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **112 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
...
|---|---:|---|
| Cells on public map | 8,510 | unchanged vs last run |
| Cells ≥1.5× capacity | 291 | unchanged vs last run |
| Share of map over capacity | 3.42% | unchanged vs last run |
| `NO_LOCATION_DATA` in drilled set | 112 | -13 (-10.4%) |
| Devices with qod < 30 (drilled) | 118 | -10 (-7.8%) |
...
2. Of the 255 devices inside the most over-capacity cells, **112** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **127** of those devices are inactive yet still counted in the cell, and **118** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 2 | 22 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 7 | 88 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 89 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 93 | 40.5993, 22.9849 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 65 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 99 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 3 | 67 | 34.8788, -99.4895 |
...
| `871ec902cffffff` | 7 | 2 | 3.5× | 2 | 85 | 40.9919, 29.0488 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 22 | — | WS1001/WG1200 | 2026-08-23T23:05:00-05:00 |
...
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 0 | — | WS1001/WG1200 | 2026-08-21T01:46:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 22 | — | WS1001/WG1200 | 2026-08-23T23:05:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-24T12:34:36+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-24T12:16:57+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 85 | — | WS2000/WS2000 | 2026-08-24T10:34:35-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 66 | — | WS2000/WS2000 | 2026-08-24T10:36:31-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-08-24T10:33:56-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-24T10:34:52-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 91 | — | WS2000/WS2000 | 2026-08-24T10:36:29-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-24T10:35:10-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-08-24T10:34:01-04:00 |
