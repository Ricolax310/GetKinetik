...
2. **122 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
...
|---|---:|---|
| Cells on public map | 8,499 | unchanged vs last run |
| Cells ≥1.5× capacity | 290 | +1 (+0.3%) |
| Share of map over capacity | 3.41% | +0.01 pp (+0.3%) |
| `NO_LOCATION_DATA` in drilled set | 122 | +16 (+15.1%) |
| Devices with qod < 30 (drilled) | 135 | +25 (+22.7%) |
...
2. Of the 250 devices inside the most over-capacity cells, **122** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **126** of those devices are inactive yet still counted in the cell, and **135** have `qod_score < 30`.
...
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 71 | 40.5993, 22.9849 |
...
| `871969046ffffff` | 4 | 1 | 4.0× | 2 | 48 | 52.0471, 5.5072 |
...
| `871eda742ffffff` | 7 | 2 | 3.5× | 4 | 63 | 37.9821, 23.6894 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-07-21T17:39:08+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-07-21T17:21:27+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 99 | — | WS1000/WG1000 | 2026-07-21T17:38:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 74 | — | WS1001/WG1200 | 2026-07-21T17:39:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-21T17:39:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-07-21T17:38:11+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 100 | — | WS1001/WG1200 | 2026-07-21T17:39:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | Y | 2 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-07-21T17:37:05+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | N | 6 | — | WS2000/WS2000 | 2026-07-21T16:12:50+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 91 | — | WS1000/WG1000 | 2026-07-21T17:38:00+03:00 |
