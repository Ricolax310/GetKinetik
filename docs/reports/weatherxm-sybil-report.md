...
- **Devices observed inside drilled cells:** 195
...
3. **102** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,509 | unchanged vs last run |
| Cells ≥1.5× capacity | 289 | unchanged vs last run |
| Share of map over capacity | 3.40% | unchanged vs last run |
| `NO_LOCATION_DATA` in drilled set | 99 | -10 (-9.2%) |
| Devices with qod < 30 (drilled) | 102 | -12 (-10.5%) |
...
2. Of the 195 devices inside the most over-capacity cells, **99** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **93** of those devices are inactive yet still counted in the cell, and **102** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 2 | 38 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 7 | 83 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 65 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 64 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 7 | 72 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | null | 19.2644, -99.0158 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 67 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 53 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 75 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 72 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 8 | 30 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 8 | 71 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 9 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 73 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 0 | null | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 3 | 51 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 51 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 23 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 5 | 60 | 37.9821, 23.6894 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 2 | 45 | 40.9919, 29.0488 |
...
| `250f3ca0-438d-11ef-8e8d-b55568dc8e66` | N | 27 | — | WS1001/WG1200 | 2026-08-18T01:37:00-05:00 |
| `2be0b091-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-10-09T03:25:12-05:00 |
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 50 | — | WS1001/WG1200 | 2026-08-20T00:27:00-05:00 |
...
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 27 | — | WS1001/WG1200 | 2026-08-18T03:38:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 50 | — | WS1001/WG1200 | 2026-08-20T00:27:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-20T17:24:12+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-20T17:07:04+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 61 | — | WS2000/WS2000 | 2026-08-20T10:25:14-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 61 | — | WS2000/WS2000 | 2026-08-20T10:25:06-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 58 | — | WS2000/WS2000 | 2026-08-20T10:23:26-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 71 | — | WS2000/WS2000 | 2026-08-20T10:24:19-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 65 | — | WS2000/WS2000 | 2026-08-20T10:25:55-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 71 | — | WS2000/WS2000 | 2026-08-20T10:24:26-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 72 | — | WS2000/WS2000 | 2026-08-20T10:23:26-04:00 |
