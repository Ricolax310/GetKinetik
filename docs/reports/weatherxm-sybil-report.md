...
- **Devices observed inside drilled cells:** 206
...
|---|---:|---|
| Cells on public map | 8,507 | -1 (-0.0%) |
| Cells ≥1.5× capacity | 290 | unchanged vs last run |
| Share of map over capacity | 3.41% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 105 | -2 (-1.9%) |
| Devices with qod < 30 (drilled) | 109 | -3 (-2.7%) |
...
2. Of the 206 devices inside the most over-capacity cells, **105** are flagged with `pol_reason: NO_LOCATION_DATA` and **0** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **113** of those devices are inactive yet still counted in the cell, and **109** have `qod_score < 30`.
...
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 76 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 8 | 55 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 8 | 85 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 0 | 9 | 19.2735, -99.1014 |
...
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 2 | 85 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 78 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 25 | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 60 | 40.9919, 29.0488 |
...
| `250f3ca0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-18T01:37:00-05:00 |
| `2be0b091-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-10-09T03:25:12-05:00 |
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 54 | — | WS1001/WG1200 | 2026-08-17T23:47:00-05:00 |
...
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-18T03:38:00-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 54 | — | WS1001/WG1200 | 2026-08-17T23:47:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-18T17:21:06+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-18T17:13:08+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 70 | — | WS2000/WS2000 | 2026-08-18T10:20:41-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 30 | — | WS2000/WS2000 | 2026-08-18T10:22:40-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-08-18T10:21:27-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 89 | — | WS2000/WS2000 | 2026-08-18T10:22:27-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 97 | — | WS2000/WS2000 | 2026-08-18T10:20:56-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 98 | — | WS2000/WS2000 | 2026-08-18T10:20:34-04:00 |
