...
2. **137 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **144** drilled devices sit below qod 30 while still counted toward cell saturation.
...
| `NO_LOCATION_DATA` in drilled set | 137 | +31 (+29.2%) |
| Devices with qod < 30 (drilled) | 144 | +35 (+32.1%) |
...
2. Of the 284 devices inside the most over-capacity cells, **137** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **140** of those devices are inactive yet still counted in the cell, and **144** have `qod_score < 30`.
...
| `8775a221bffffff` | 4 | 1 | 4.0× | 4 | 61 | 7.2367, -9.1619 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-05T17:45:20+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-05T17:29:00+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-05T10:31:01-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 68 | — | WS2000/WS2000 | 2026-08-05T10:31:02-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-05T10:29:45-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-05T10:30:26-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 89 | — | WS2000/WS2000 | 2026-08-05T10:29:38-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-05T10:32:13-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-08-05T10:29:47-04:00 |
