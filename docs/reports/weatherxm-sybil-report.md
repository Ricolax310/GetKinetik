...
- **Devices observed inside drilled cells:** 205
...
| Cells ≥1.5× capacity | 288 | -2 (-0.7%) |
| Share of map over capacity | 3.39% | -0.02 pp (-0.7%) |
| `NO_LOCATION_DATA` in drilled set | 100 | -12 (-10.7%) |
| Devices with qod < 30 (drilled) | 109 | -25 (-18.7%) |
...
2. Of the 205 devices inside the most over-capacity cells, **100** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **125** of those devices are inactive yet still counted in the cell, and **109** have `qod_score < 30`.
...
| `871eda743ffffff` | 27 | 3 | 9.0× | 6 | 85 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 7 | 98 | 40.5993, 22.9849 |
| `872aaa945ffffff` | 8 | 1 | 8.0× | 7 | 87 | 39.1691, -77.3527 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 89 | 39.2480, -77.2449 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 45 | 30.8796, -88.3141 |
...
| `874995854ffffff` | 4 | 1 | 4.0× | 2 | 1 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 0 | null | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 89 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 3 | 63 | 52.0471, 5.5072 |
...
| `8726c35a9ffffff` | 4 | 1 | 4.0× | 3 | 94 | 34.8702, -99.5157 |
| `874995809ffffff` | 4 | 1 | 4.0× | 0 | 31 | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 6 | 74 | 37.9821, 23.6894 |
...
| `fe601050-963e-11ec-900c-abdec1c57354` | N | 71 | — | WS1000/WG1000 | 2026-07-08T15:28:00+03:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 98 | — | WS1001/WG1200 | 2026-07-10T17:52:47+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | N | 71 | — | WS1000/WG1000 | 2026-07-08T15:28:00+03:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-07-10T17:53:16+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `2c12b2b0-8e55-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-07-10T17:52:00+03:00 |
| `2779d400-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-10T17:53:00+03:00 |
| `27686ee1-438d-11ef-8e8d-b55568dc8e66` | Y | 99 | — | WS1001/WG1200 | 2026-07-10T17:53:00+03:00 |
| `b86263c0-bf53-11ed-95eb-b351f0b0cc44` | Y | 96 | — | WS2000/WS2000 | 2026-07-10T17:52:01+03:00 |
| `2d57c030-438d-11ef-8e8d-b55568dc8e66` | Y | 100 | — | WS1001/WG1200 | 2026-07-10T17:53:00+03:00 |
| `33e7a2d0-bf54-11ed-9972-4f669f2d96bd` | N | 96 | — | WS2000/WS2000 | 2026-07-10T10:17:26+03:00 |
| `af1f1760-bf51-11ed-9972-4f669f2d96bd` | N | 95 | — | WS2000/WS2000 | 2026-07-09T17:22:17+03:00 |
| `25590d00-8835-11ec-966b-a173bf0cd052` | Y | 100 | — | WS1000/WG1000 | 2026-07-10T17:52:00+03:00 |
