...
- **Cells over designed capacity (≥1.5× capacity):** 291 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 315

## Executive summary

1. **291 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **147 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **157** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,505 | +1 (+0.0%) |
| Cells ≥1.5× capacity | 291 | -2 (-0.7%) |
| Share of map over capacity | 3.42% | -0.02 pp (-0.7%) |
| `NO_LOCATION_DATA` in drilled set | 147 | +53 (+56.4%) |
| Devices with qod < 30 (drilled) | 157 | +58 (+58.6%) |
...
1. **291 cells** report more devices than the cell's designed capacity. Capacity is a WeatherXM-defined limit (the network's own model of how many devices a hex should sensibly hold).
2. Of the 315 devices inside the most over-capacity cells, **147** are flagged with `pol_reason: NO_LOCATION_DATA` and **2** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **153** of those devices are inactive yet still counted in the cell, and **157** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 2 | 54 | 33.8746, -94.8049 |
| `871eda743ffffff` | 29 | 3 | 9.7× | 8 | 94 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 91 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 67 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 96 | 39.2480, -77.2449 |
...
| `874450316ffffff` | 5 | 1 | 5.0× | 4 | 78 | 30.8796, -88.3141 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 5 | 96 | 48.5924, 9.1617 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 50 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 8 | 80 | 47.1792, 27.5966 |
...
| `8726c351affffff` | 4 | 1 | 4.0× | 3 | 85 | 34.8788, -99.4895 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 2 | 80 | 0.4685, 35.2356 |
| `8726c35a9ffffff` | 4 | 1 | 4.0× | 3 | 96 | 34.8702, -99.5157 |
| `874995809ffffff` | 4 | 1 | 4.0× | 1 | 26 | 19.2595, -99.0815 |
| `871ec902cffffff` | 7 | 2 | 3.5× | 3 | 59 | 40.9919, 29.0488 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 54 | — | WS1001/WG1200 | 2026-08-16T00:34:00-05:00 |
...
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-08-16T00:34:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-16T17:11:40+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-16T17:10:41+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 98 | — | WS2000/WS2000 | 2026-08-16T10:13:54-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | N | 60 | — | WS2000/WS2000 | 2026-08-16T00:54:32-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 96 | — | WS2000/WS2000 | 2026-08-16T10:12:51-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 100 | — | WS2000/WS2000 | 2026-08-16T10:13:46-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 86 | — | WS2000/WS2000 | 2026-08-16T10:12:18-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 100 | — | WS2000/WS2000 | 2026-08-16T10:13:44-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 100 | — | WS2000/WS2000 | 2026-08-16T10:12:50-04:00 |
