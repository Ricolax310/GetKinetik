...
- **Cells observed:** 8,488
- **Cells over designed capacity (≥1.5× capacity):** 288 (3.4%)
- **Cells drilled in this report:** 60 (top by capacity ratio)
- **Devices observed inside drilled cells:** 169

## Executive summary

1. **288 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **79 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
3. **101** drilled devices sit below qod 30 while still counted toward cell saturation.
...
|---|---:|---|
| Cells on public map | 8,488 | -2 (-0.0%) |
| Cells ≥1.5× capacity | 288 | unchanged vs last run |
| Share of map over capacity | 3.39% | +0.00 pp (+0.0%) |
| `NO_LOCATION_DATA` in drilled set | 79 | +11 (+16.2%) |
| Devices with qod < 30 (drilled) | 101 | +8 (+8.6%) |
...
2. Of the 169 devices inside the most over-capacity cells, **79** are flagged with `pol_reason: NO_LOCATION_DATA` and **8** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **99** of those devices are inactive yet still counted in the cell, and **101** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 1 | 25 | 33.8746, -94.8049 |
| `871eda743ffffff` | 28 | 3 | 9.3× | 3 | 83 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 5 | null | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 6 | 99 | 40.5993, 22.9849 |
| `872aae2cdffffff` | 7 | 1 | 7.0× | 6 | 99 | 39.2480, -77.2449 |
| `8726cdb68ffffff` | 7 | 1 | 7.0× | 0 | null | 33.8068, -94.7452 |
| `874995819ffffff` | 6 | 1 | 6.0× | 0 | null | 19.2644, -99.0158 |
| `871e15312ffffff` | 5 | 1 | 5.0× | 5 | 92 | 47.7470, 16.2250 |
| `874450316ffffff` | 5 | 1 | 5.0× | 3 | 99 | 30.8796, -88.3141 |
| `873933759ffffff` | 5 | 1 | 5.0× | 2 | 51 | 38.7867, -9.1042 |
| `871faa694ffffff` | 5 | 1 | 5.0× | 3 | 98 | 48.5924, 9.1617 |
| `8726c351affffff` | 5 | 1 | 5.0× | 2 | 87 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 0 | 54 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 4 | 83 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | 66 | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 1 | 24 | 19.2735, -99.1014 |
| `8775a221bffffff` | 4 | 1 | 4.0× | 1 | 87 | 7.2367, -9.1619 |
| `872aac992ffffff` | 4 | 1 | 4.0× | 4 | 96 | 40.2933, -75.7373 |
| `871969046ffffff` | 4 | 1 | 4.0× | 4 | 50 | 52.0471, 5.5072 |
| `871ee58a4ffffff` | 4 | 1 | 4.0× | 2 | 95 | 46.3285, 23.7291 |
| `877a4c068ffffff` | 4 | 1 | 4.0× | 0 | 48 | 0.4685, 35.2356 |
| `874995809ffffff` | 4 | 1 | 4.0× | 0 | null | 19.2595, -99.0815 |
| `871eda742ffffff` | 7 | 2 | 3.5× | 3 | 78 | 37.9821, 23.6894 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-02-20T13:27:00-06:00 |
| `2683db41-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-12-20T16:56:41-06:00 |
| `33fe5390-438d-11ef-8e8d-b55568dc8e66` | Y | 25 | — | WS1001/WG1200 | 2026-05-23T19:53:00-05:00 |
| `2e198990-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-10-09T00:29:10-05:00 |
| `3359af20-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2025-10-10T01:15:55-05:00 |
| `25eb6bd0-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-02-20T13:27:00-06:00 |
...
| `fe601050-963e-11ec-900c-abdec1c57354` | N | 0 | NO_LOCATION_DATA | WS1000/WG1000 | 2026-03-03T22:08:00+02:00 |
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-05-24T03:53:09+03:00 |
| `571e4820-0bd4-11f0-b641-13ebff23371f` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-05-14T09:57:00+03:00 |
| `a866f0a0-ab98-11ec-966b-a173bf0cd052` | N | 0 | NO_LOCATION_DATA | WS1000/WG1000 | 2025-12-28T10:45:00+02:00 |
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-05-24T03:43:53+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:53:22-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:53:40-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:52:48-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:53:39-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:51:58-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-04-09T20:23:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:53:49-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 0 | QOD_THRESHOLD_NOT_REACHED | WS2000/WS2000 | 2026-05-23T20:52:55-04:00 |
