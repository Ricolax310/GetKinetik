...
- **Devices observed inside drilled cells:** 248

## Executive summary

1. **290 cells** exceed designed capacity — §1 lists H3 indices + map centers for your ops queue.
2. **107 devices** in the hottest cells carry WeatherXM's own `NO_LOCATION_DATA` flag — compare to your internal pol pipeline, not ours.
...
| Cells ≥1.5× capacity | 290 | unchanged vs last run |
| Share of map over capacity | 3.41% | -0.00 pp (-0.0%) |
| `NO_LOCATION_DATA` in drilled set | 107 | +9 (+9.2%) |
| Devices with qod < 30 (drilled) | 117 | +12 (+11.4%) |
...
2. Of the 248 devices inside the most over-capacity cells, **107** are flagged with `pol_reason: NO_LOCATION_DATA` and **1** with another `pol_reason` value — all set by WeatherXM's own pipeline.
3. **110** of those devices are inactive yet still counted in the cell, and **117** have `qod_score < 30`.
...
| `8726cdb66ffffff` | 10 | 1 | 10.0× | 1 | 20 | 33.8746, -94.8049 |
| `871eda743ffffff` | 29 | 3 | 9.7× | 8 | 94 | 37.9810, 23.7195 |
| `872b0e115ffffff` | 9 | 1 | 9.0× | 0 | null | 44.5481, -64.3423 |
| `872aaa945ffffff` | 9 | 1 | 9.0× | 7 | 76 | 39.1691, -77.3527 |
| `871edcd23ffffff` | 8 | 1 | 8.0× | 8 | 68 | 40.5993, 22.9849 |
...
| `8726c351affffff` | 5 | 1 | 5.0× | 4 | 90 | 34.8788, -99.4895 |
| `877a6ac76ffffff` | 9 | 2 | 4.5× | 9 | 56 | -0.6674, 36.3085 |
| `871e556e1ffffff` | 8 | 2 | 4.0× | 8 | 74 | 47.1792, 27.5966 |
| `87274d6b4ffffff` | 4 | 1 | 4.0× | 0 | null | 42.6764, -84.5014 |
| `874995854ffffff` | 4 | 1 | 4.0× | 1 | 15 | 19.2735, -99.1014 |
...
| `24355760-438d-11ef-8e8d-b55568dc8e66` | N | 20 | — | WS1001/WG1200 | 2026-08-15T01:39:00-05:00 |
...
| `d3debb80-862b-11ef-bb6a-31ace5ea88be` | Y | 99 | — | WS1001/WG1200 | 2026-08-15T17:11:22+03:00 |
...
| `db6200f0-784e-11ef-a8d1-1fe2597b4789` | Y | 100 | — | WS1001/WG3000 | 2026-08-15T17:09:13+03:00 |
...
| Device ID | Active | QoD | pol_reason | Bundle | Last activity |
|---|:-:|---:|---|---|---|
| `cc45d4c0-bf54-11ed-95eb-b351f0b0cc44` | Y | 73 | — | WS2000/WS2000 | 2026-08-15T10:13:08-04:00 |
| `f07b5a00-bf53-11ed-8a70-d7d4cf200cc9` | Y | 52 | — | WS2000/WS2000 | 2026-08-15T10:12:03-04:00 |
| `354db7f0-bf53-11ed-9972-4f669f2d96bd` | Y | 73 | — | WS2000/WS2000 | 2026-08-15T10:12:27-04:00 |
| `ec8520f0-bf50-11ed-95eb-b351f0b0cc44` | Y | 85 | — | WS2000/WS2000 | 2026-08-15T10:13:00-04:00 |
| `36e5f940-bf55-11ed-8a70-d7d4cf200cc9` | Y | 82 | — | WS2000/WS2000 | 2026-08-15T10:11:56-04:00 |
| `2c2d9810-438d-11ef-8e8d-b55568dc8e66` | N | 0 | NO_LOCATION_DATA | WS1001/WG1200 | 2026-07-31T11:08:00-04:00 |
| `74ad1920-bf55-11ed-9972-4f669f2d96bd` | Y | 85 | — | WS2000/WS2000 | 2026-08-15T10:13:20-04:00 |
| `7f0c20a0-bf55-11ed-8a70-d7d4cf200cc9` | N | 0 | NO_LOCATION_DATA | WS2000/WS2000 | 2026-03-11T18:57:20-04:00 |
| `f83c3700-bf53-11ed-8a70-d7d4cf200cc9` | Y | 85 | — | WS2000/WS2000 | 2026-08-15T10:12:28-04:00 |
