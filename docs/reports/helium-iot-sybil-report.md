...
- **Hotspots observed (with coordinates):** 1,008,245
- **Hotspots without asserted location:** 27,414
- **Hotspots flagged (any heuristic):** 69,732 (6.92%)

## Executive summary

1. **4,861 single-coordinate stacks of ≥10 hotspots** on 1,008,245 located units — the largest stack holds **501 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
...
|---|---:|---|
| Hotspots with asserted coordinates | 1,008,245 | unchanged vs last run |
