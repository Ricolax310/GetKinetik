...
- **Hotspots observed (with coordinates):** 1,008,267
- **Hotspots without asserted location:** 27,416
- **Hotspots flagged (any heuristic):** 69,738 (6.92%)

## Executive summary

1. **4,861 single-coordinate stacks of ≥10 hotspots** on 1,008,267 located units — the largest stack holds **501 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
2. **27,416 hotspots exist on-chain with no asserted location** — on the registry but not on the map.
...
|---|---:|---|
| Hotspots with asserted coordinates | 1,008,267 | unchanged vs last run |
...
2. **27,416 hotspots have no asserted location** — they exist on-chain but not on the map.

---

## 1. Largest single-coordinate stacks — 4,861 total
...
| `51.31643,6.182851` | 87 | `11xapR2HqHZJ6EbF2tgsBTbm…`, `11eQ2WFYYZfWCnuQtTaFuUpS…`, `11bQusUSF77V4xLZMA1to1w4…` |
...
_…and 4,851 more in the snapshot file._
