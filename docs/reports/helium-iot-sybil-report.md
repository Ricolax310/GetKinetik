...
- **Hotspots observed (with coordinates):** 1,008,126
- **Hotspots without asserted location:** 27,407
- **Hotspots flagged (any heuristic):** 69,675 (6.91%)

## Executive summary

1. **4,858 single-coordinate stacks of ≥10 hotspots** on 1,008,126 located units — the largest stack holds **502 hotspots on one coordinate** (§1 lists keys your registry team can grep today).
