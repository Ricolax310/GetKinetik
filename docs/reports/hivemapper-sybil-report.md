...
- **Sum of top 20 largest SPL token accounts:** 3,217,916,084.787 HONEY (49.09% of UI supply)
...
1. **49.09% of UI-reported HONEY** sits in the **top 20 visible SPL accounts** (Solana RPC cap) — economic *shape* for treasury/MM review, not a contributor GPS read.
...
1. **Top 20 visible SPL accounts hold 49.09% of UI-reported supply** (3,217,916,084.787 HONEY).
...
| 18 | `6LY1JzAFVZsP2a2xKrtU6znQMQ5h4i7tocWdgrkZzkzF` | `HXLRfE7oKRyktLyVojzbckKpqWcGmdukrrrLXmXWrvrZ` | 110,116,309.69 | 1.68% |
...
| 18 | 3,000,649,736.79 | 45.78% |
| 19 | 3,109,542,549.68 | 47.44% |
| 20 | 3,217,916,084.79 | 49.09% |
