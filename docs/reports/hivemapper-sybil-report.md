...
- **Reported circulating / UI supply:** 6,557,840,637.279 HONEY
- **Sum of top 20 largest SPL token accounts:** 3,215,782,552.94 HONEY (49.04% of UI supply)
...
|---|---:|---|
| Top-20 visible SPL accounts (% of UI supply) | 49.04% | -0.00 pp (-0.0%) |
| Sum of top-20 balances (HONEY) | 3,215,782,552.94 | -26,456.305 (-0.0%) |
...
1. **Top 20 visible SPL accounts hold 49.04% of UI-reported supply** (3,215,782,552.94 HONEY).
...
| 20 | `6LY1JzAFVZsP2a2xKrtU6znQMQ5h4i7tocWdgrkZzkzF` | `HXLRfE7oKRyktLyVojzbckKpqWcGmdukrrrLXmXWrvrZ` | 107,982,777.84 | 1.65% |
