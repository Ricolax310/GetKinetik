...
- **Reported circulating / UI supply:** 6,544,410,565.573 HONEY
- **Sum of top 20 largest SPL token accounts:** 3,215,424,456.044 HONEY (49.13% of UI supply)
...
2. **Top 5 accounts alone: 20.87%** of supply — see § Part A table for owner wallets to reconcile with custody labels.
...
|---|---:|---|
| Top-20 visible SPL accounts (% of UI supply) | 49.13% | -0.02 pp (-0.0%) |
| Sum of top-20 balances (HONEY) | 3,215,424,456.044 | unchanged vs last run |
| UI-reported supply (HONEY) | 6,544,410,565.573 | +2,509,230.758 (+0.0%) |
...
1. **Top 20 visible SPL accounts hold 49.13% of UI-reported supply** (3,215,424,456.044 HONEY).
2. **Top 5 accounts: 20.87%** — worth matching to known custody before inferring contributor risk.
...
| 5 | 1,365,713,565.26 | 20.87% |
| 6 | 1,518,394,023.46 | 23.20% |
| 7 | 1,662,959,062.03 | 25.41% |
| 8 | 1,807,316,876.74 | 27.62% |
| 9 | 1,937,194,607.89 | 29.60% |
| 10 | 2,063,310,177.81 | 31.53% |
| 11 | 2,189,212,450.27 | 33.45% |
| 12 | 2,311,400,941.71 | 35.32% |
| 13 | 2,430,378,820.96 | 37.14% |
| 14 | 2,548,490,144.31 | 38.94% |
| 15 | 2,665,116,547.7 | 40.72% |
| 16 | 2,778,331,541 | 42.45% |
| 17 | 2,890,533,427.1 | 44.17% |
| 18 | 2,999,426,239.99 | 45.83% |
| 19 | 3,107,799,775.1 | 47.49% |
| 20 | 3,215,424,456.04 | 49.13% |
