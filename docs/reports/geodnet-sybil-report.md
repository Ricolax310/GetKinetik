...
- **Stations flagged (any heuristic):** 5,343 (27.41%)

## Executive summary

1. **1009 exact (lat,lng) duplicate groups** on 19,496 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
|---|---:|---|
| Stations with coordinates | 19,496 | unchanged vs last run |
| Exact (lat,lng) duplicate groups | 1,009 | +1 (+0.1%) |
| Clusters within 10 m | 1,009 | +1 (+0.1%) |
| Clusters ≥4 within 100 m | 2 | -1 (-33.3%) |
| Low-precision coordinates (≤2 decimals) | 3,721 | +1 (+0.0%) |
| Fleet share flagged (any heuristic) | 27.41% | +0.01 pp (+0.0%) |
...
| `40.777, 29.689` | 3 | `****81599`, `****B82E1`, `****3B246` |
...
| 40.77700, 29.68900 | 3 | `****81599`, `****B82E1`, `****3B246` |
