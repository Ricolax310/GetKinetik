...
- **Stations flagged (any heuristic):** 5,350 (27.45%)

## Executive summary

1. **1017 exact (lat,lng) duplicate groups** on 19,492 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
|---|---:|---|
| Stations with coordinates | 19,492 | unchanged vs last run |
| Exact (lat,lng) duplicate groups | 1,017 | -1 (-0.1%) |
| Clusters within 10 m | 1,017 | -1 (-0.1%) |
| Clusters ≥4 within 100 m | 3 | unchanged vs last run |
| Low-precision coordinates (≤2 decimals) | 3,717 | +1 (+0.0%) |
| Fleet share flagged (any heuristic) | 27.45% | -0.01 pp (-0.0%) |
...
| 43.14900, -72.86600 | 2 | `****14359`, `****22C1E` |
