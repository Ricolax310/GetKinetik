...
- **Stations observed:** 19,483
- **Stations flagged (any heuristic):** 5,331 (27.36%)

## Executive summary

1. **1004 exact (lat,lng) duplicate groups** on 19,483 public stations — each row in §1 is one coordinate pair your registry team can grep today.
...
|---|---:|---|
| Stations with coordinates | 19,483 | -6 (-0.0%) |
| Exact (lat,lng) duplicate groups | 1,004 | unchanged vs last run |
| Clusters within 10 m | 1,004 | unchanged vs last run |
