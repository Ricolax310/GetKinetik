...
> Week 2026-W26 · 2026-06-22 → 2026-06-22 · patterns first, then networks.

## Executive Summary

- Week 2026-W26: cross-network signal index updated from public infrastructure reads.
- 2 publishable signal(s) across 5 network(s) met the weekly confidence gate.
...
**Signal:** Over-capacity H3 cells observed at 287.
...
**Signal:** Exact coordinate-duplicate groups declined from 10 to 9 on Geodnet.
...
**Signal:** Top-20 account share of supply observed near 49.14%.
...
- entities on public map: 19,604 (+16 (+0.1%))
