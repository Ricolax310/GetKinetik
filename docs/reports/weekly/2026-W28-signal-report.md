...
> Week 2026-W28 · 2026-07-06 → 2026-07-10 · patterns first, then networks.
...
**Signal:** Over-capacity H3 cells declined from 290 to 288.
...
**Signal:** Exact coordinate-duplicate groups rose from 7 to 9 on Geodnet.
...
**What changed**
- cells over designed capacity: 288 (-2 (-0.7%))
