...
> Week 2026-W31 · 2026-07-27 → 2026-07-30 · patterns first, then networks.

## Executive Summary

- Week 2026-W31: cross-network signal index updated from public infrastructure reads.
...
**Signal:** Over-capacity H3 cells rose from 287 to 288.
...
**Signal:** Exact coordinate-duplicate groups declined from 7 to 5 on Geodnet.
