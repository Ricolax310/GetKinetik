...
> Week 2026-W30 · 2026-07-20 → 2026-07-20 · patterns first, then networks.
...
**Signal:** Top-20 account share of supply observed near 50.67%.
...
**What changed**
- entities on public map: 8,492 (-6 (-0.1%))
...
**What changed**
- entities on public map: 19,593 (-7 (-0.0%))
...
**What changed**
- top-20 SPL share of UI supply: 50.67% (-0.28 pp (-0.6%))
