...
> Week 2026-W39 · 2026-09-21 → 2026-09-22 · patterns first, then networks.
...
**Signal:** Over-capacity H3 cells rose from 299 to 300.
...
**Signal:** Exact coordinate-duplicate groups rose from 1002 to 1079 on Geodnet.
...
**Signal:** Top-20 account share of supply observed near 52.29%.
...
**What changed**
- cells over designed capacity: 300 (+1 (+0.3%))
...
- entities on public map: 19,594 (+83 (+0.4%))
...
**What changed**
- entities on public map: 56,118 (+9 (+0.0%))
