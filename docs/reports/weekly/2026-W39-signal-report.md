...
> Week 2026-W39 · 2026-09-21 → 2026-09-21 · patterns first, then networks.
...
**Signal:** Over-capacity H3 cells rose from 299 to 301.
...
**Signal:** Top-20 account share of supply observed near 52.49%.
...
**What changed**
- cells over designed capacity: 301 (+2 (+0.7%))
...
**What changed**
- entities on public map: 158,664 (+7 (+0.0%))
